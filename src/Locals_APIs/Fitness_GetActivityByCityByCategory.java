...
public class Fitness_GetActivityByCityByCategory {
    ...
    /*{"cityId":"2","cityName":"Bangalore","id":"2","supplier":"fit_ticket"}
    {"cityId":"1","cityName":"Mumbai","id":"1","supplier":"fit_ticket"}
    {"cityId":"4","cityName":"Delhi","id":"4","supplier":"fit_ticket"}
    {"cityId":"3","cityName":"Pune","id":"3","supplier":"fit_ticket"}*/
    ...
    public void getOperatingCities() {
		...
		String searchUrl="http://fitfeeds.cloudapp.net:8080/B2BAPIPlatform/GetActivityCategoryList/v1?cityId=3&+catid=12";
