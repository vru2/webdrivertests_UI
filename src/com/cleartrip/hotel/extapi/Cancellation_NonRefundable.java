...
public class Cancellation_NonRefundable extends IndiaHotels {
    ...
    public void CancellationPolicy_NonRefundable() throws Exception {
        ...
        try {
            ...
            String [ ] getrate_breakdown = hotelDetails.split("</rate-breakdown>");
            ...
            System.out.println("Cancellation Policy : " + cancellationPolicyXML);
            ...
            if(!Cancel_Policy1[0].contains("This booking is non-refundable")) {
            	Reporter.log("Cancellation policy is displayed as :  "+Cancel_Policy1[0]);
            	Assert.assertFalse(true);
            }
            if(!refundDetails[0].contains("NON-REFUNDABLE")) {
            	Reporter.log("Cancellation policy is displayed as :  "+Cancel_Policy1[0]);
            	Assert.assertFalse(true);
            }         
