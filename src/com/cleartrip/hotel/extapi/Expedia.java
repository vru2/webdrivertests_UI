...
public class Expedia extends IndiaHotels {
    ...
    public void Expedia_Ext_Api() throws Exception {
        ...
        try {
            HttpGet getRequest = new HttpGet(api_url() + "/hotels/1.0/search?check-in=" + putDateApi(chkinDate) + "&check-out=" + putDateApi(chkoutDate) + "&no-of-rooms="
                    + number_of_rooms + "&adults-per-room=" + adults_per_room + "&children-per-room=" + children_per_room + "&city="+City+"&country=TH");
          ...
          //  System.out.println(hotelDetails);
           ...
           //System.out.println("Provisional_book XML :"+provisional_book);
            ...
            Reporter.log("Provisional-id Expedia = " + provisional[0]);
            if ( api_payment_flag() ) {
            ...
            if ( debug_mode ) {
               ...
               //  System.out.println("------------------------------------------------------------------");
                ...
                System.out.println("API TripID Expedia : " + Tripid[0]);
                ...
                Reporter.log("API TripID Expedia MultiPax : " + Tripid[0]);
            ...
            /*    assertEquals(Total, Cost_Price);
                ...
                if ( debug_mode ) {
                  System.out.println("Api Expedia Hotels TripID = " + Tripid[0]);
                   Reporter.log("Api Expedia Hotels TripID = " + Tripid[0]);
                   ...
                   Reporter.log("<supplier-cancellation> = " + Status[0]);
                	...
                	System.out.println("Api Hotels Expedia TripID = " + Tripid[0]);     	
                    Reporter.log("Api Hotels Expedia TripID = " + Tripid[0]);
                    Reporter.log("<confirmation-number>   = " + confirmation_number[0]);
                    Reporter.log("<Cost Price>            = " + Cost_Price);
                    Reporter.log("<Deduction Amount>      = " + Deduction);
                    Reporter.log("<Refund Amount>         = " + refund_amount[0]);
                ...
                logger.info("Ext Api Expedia Hotels TripID = " + Tripid[0]);
            }
        }
