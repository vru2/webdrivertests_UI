...
public class Expedia_Intl extends IndiaHotels {
           ...
           //System.out.println("Provisional_book XML :"+provisional_book);
            ...
            if ( debug_mode ) {
               ...
               //  System.out.println("------------------------------------------------------------------");
                ...
                System.out.println("API TripID MultiPax : " + Tripid[0]);
                ...
                Reporter.log("API TripID MultiPax : " + Tripid[0]);
            ...
            /*    assertEquals(Total, Cost_Price);
                ...
                if ( debug_mode ) {
                  System.out.println("Api Hotels TripID = " + Tripid[0]);
                   Reporter.log("Api Hotels TripID = " + Tripid[0]);
