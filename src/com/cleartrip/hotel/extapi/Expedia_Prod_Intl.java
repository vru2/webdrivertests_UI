...
public class Expedia_Prod_Intl extends IndiaHotels {
    ...
    public void Api_Hotel() throws Exception {
        ...
        try {
         ...
         // ################################# Post - Book Request ############################## //
            ...
            Reporter.log("Expedia Intl Provisional ID : " + provisional[0]);
           //System.out.println("Expedia Intl Provisional ID : " + provisional[0]);
