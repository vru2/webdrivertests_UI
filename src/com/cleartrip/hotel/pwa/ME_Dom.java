...
public class ME_Dom extends PWAHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

	@DataProvider(name="PWA_Dom")
	public Object [ ][ ] Hotel_Dom() throws Exception {
		return new Object [ ] [ ] { { "Jaipur", "2", "1", "1", "55","56", "", "Dom ", "Your booking is done"}};
	}
	
	  @Test ( dataProvider = "PWA_Dom")
  	public void MobileME_Hotel_Booking(String City, String Adults, String Childrens, String Rooms, String CheckIN, String CheckOut, String HoteName, String TripLoggerMsg, String ConfrmMsg) throws Exception {
