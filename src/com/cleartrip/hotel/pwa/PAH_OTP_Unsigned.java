...
public class PAH_OTP_Unsigned extends PWAHotels {
	public RemoteWebDriver driver;
	private String baseUrl;

	@DataProvider(name="PWA_Dom")
	public Object [ ][ ] Hotel_domestic() throws Exception {
		return new Object [ ] [ ] { { "Golden Guest House", "2", "1", "1", "60","61", "", "PAH Unsigned", "Your booking is done"}};
	}
	
	  @Test ( dataProvider = "PWA_Dom")
	  public void PWA_Hotel_PAHUnsigned(String City, String Adults, String Childrens, String Rooms, String CheckIN, String CheckOut, String HoteName, String TripLoggerMsg, String ConfrmMsg) throws Exception {
		  ...
		  paymentStepPWA(driver, "PAHOTP" , "", TripLoggerMsg);
