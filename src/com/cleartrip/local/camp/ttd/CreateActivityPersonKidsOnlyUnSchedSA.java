...
public class CreateActivityPersonKidsOnlyUnSchedSA extends CampActivities {
	@Parameters({ "user" ,"domain"})
	@Test
	public void CreateActivitySaKids_36071(String user,String domain) throws Exception {
		Boolean flag=false;
		...
		String activityId = NewActivityFormThree("NotScheduledActivity", "shared", " ", "Yes",domain);
