...
public class CreateActivityPricePerPersonSchedSA extends CampActivities {

	@Parameters({ "user" ,"domain"})
	@Test
	public void CreateActivitysa_35730(String user,String domain) throws Exception {
		Boolean flag=false;
		...
		String activityId = NewActivityFormThree("ScheduledActivity", "shared", "Pricing Per Person", "",domain);
