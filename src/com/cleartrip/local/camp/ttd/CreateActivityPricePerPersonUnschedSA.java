...
public class CreateActivityPricePerPersonUnschedSA extends CampActivities {

	@Parameters({ "user","domain" })
	@Test
	public void CreateActivitysa_36072(String user,String domain) throws Exception {
		Boolean flag=false;
		...
		String activityId = NewActivityFormThree("NotScheduledActivity", "shared", "Pricing Per Person", "",domain);
