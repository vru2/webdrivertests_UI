...
public class CreateActivityPricePerUnitUnschedSA extends CampActivities {
	@Parameters({ "user" ,"domain"})
	@Test
	public void CreateActivitySaUnit_35731(String user,String domain) throws Exception {
		Boolean flag=false;
		...
		String activityId = NewActivityFormThree("NotScheduledActivity", "shared", "pricingTypeSlot", "",domain);
