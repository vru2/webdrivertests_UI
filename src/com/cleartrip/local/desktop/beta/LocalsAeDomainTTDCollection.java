...
public class LocalsAeDomainTTDCollection extends Locals{
 ...
 @Test (groups= "Smoke Tests")
  public void LocalTTDCaraousal() throws Exception {
	  ...
	  driver.get("https://www.cleartrip.ae/local/dubai/things-to-do-in-dubai");
	  //driver.get("https://qa2.cleartrip.com/local/bijapur/things-to-do-in-bijapur");
      ...
      driver.findElement(By.xpath("(//a[@class='card typeCollection'])[4]")).click();
     // Thread.sleep(3000);
      //scrollToElement(driver, By.xpath("//div/h2"));
      JavascriptExecutor jse = (JavascriptExecutor) driver;
      jse.executeScript("window.scrollBy(0,300)", "");
      safeClick(driver, By.xpath("(//div/a)[9]"));
