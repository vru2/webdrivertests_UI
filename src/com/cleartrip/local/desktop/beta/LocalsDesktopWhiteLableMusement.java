...
public class LocalsDesktopWhiteLableMusement extends Locals{
 ...
 @Test (groups= "Smoke Tests")
  public void LocalTTDCaraousal() throws Exception {
	  ...
	  driver.get("https://julywl.triplocal.com/activities/paris/things-to-do");
      ...
      safeClick(driver,By.xpath("(//img[@id='0'])[1]") );
      ...
      Thread.sleep(3000);
      safeClick(driver, By.xpath("(//div/a)[5]"));
