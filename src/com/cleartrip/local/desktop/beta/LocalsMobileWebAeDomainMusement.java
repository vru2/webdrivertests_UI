...
import domainServices.Locals;
	...
	public class LocalsMobileWebAeDomainMusement extends Locals{
  ...
  public void LocalsMobileWeb_TTD_AdultAE_5561() throws Exception {
	 ...
	 driver.get("https://www.cleartrip.ae/local/paris/things-to-do-in-paris");
	 Thread.sleep(2000);
	 safeClick(driver, By.xpath("(//h2[@class='metaName truncate'])[6]"));
