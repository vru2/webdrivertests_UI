...
import domainServices.Locals;
	...
	public class LocalsMobileWebAeDomainTTDAdult extends Locals{
  ...
  public void LocalsMobileWeb_TTD_AdultAE_5561() throws Exception {
	 ...
	 driver.get("https://www.cleartrip.ae/activities/dubai/things-to-do");
	 Thread.sleep(2000);
	 safeClick(driver, By.xpath("(//h2[@class='metaName truncate'])[2]"));
