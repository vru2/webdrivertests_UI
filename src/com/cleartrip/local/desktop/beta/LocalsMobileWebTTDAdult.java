...
import domainServices.Locals;
	...
	public class LocalsMobileWebTTDAdult extends Locals{
  ...
  public void LocalsMobileWeb_TTD_AdultAE_5561() throws Exception {
	 ...
	 driver.get("https://www.cleartrip.com/local/dubai/things-to-do-in-dubai");
	 Thread.sleep(2000);
	 ...
	 Thread.sleep(2000);
	// Select Dropdown = new Select(driver.findElement(By.id("options")));
	// Dropdown.selectByValue("155779");
	// locals_BookFlow_MobileWeb(driver, "TTD", "Adult");
