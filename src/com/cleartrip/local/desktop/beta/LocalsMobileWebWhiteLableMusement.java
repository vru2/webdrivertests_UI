...
import domainServices.Locals;
	...
	public class LocalsMobileWebWhiteLableMusement extends Locals{
  ...
  public void LocalsMobileWeb_TTD_AdultAE_5561() throws Exception {
	 ...
	 driver.get("https://julywl.triplocal.com/local/paris/things-to-do-in-paris");
	 safeClick(driver,By.xpath("(//img[@id='0'])[2]") );
	 Thread.sleep(2000);
