...
public class LocalsTTDCollection extends Locals{
 ...
 @Test (groups= "Smoke Tests")
  public void LocalTTDCaraousal() throws Exception {
	  ...
	  driver.get("https://www.cleartrip.com/local/bangalore/things-to-do-in-bangalore");
      ...
      safeClick(driver, By.xpath("(//div/a)[3]"));
