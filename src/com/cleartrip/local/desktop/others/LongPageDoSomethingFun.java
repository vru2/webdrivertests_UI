...
public class LongPageDoSomethingFun extends Locals {
	...
	@Test
	public void latestDoSomthingFun_Local() throws Exception {
		driver.get(baseUrl);
		verifyLastestFun(driver);
	...
	private void verifyLastestFun(RemoteWebDriver driver) {
		try {
			Thread.sleep(3000);
			String firstFunLoc, firstActivityLoc, secondActivityLoc, funName, activityName;

			firstFunLoc = "//div[@id='localLongForm']//div[@class='localCollectionWrapper']//a[1]";
			...
			funName = getText(driver,
					By.xpath("//div[@id='localLongForm']//div[@class='localCollectionWrapper']//h1[1]"));
