...
public class KlookWithAdditionalInfo extends Locals {
	...
	public void LocalTTDAdult_5540() throws Exception {
		...
		locals_NameSearch_TTD(driver, dataFile.value("Locals_Klook_collection_name_AdditionalInfo_WithoutList"),
