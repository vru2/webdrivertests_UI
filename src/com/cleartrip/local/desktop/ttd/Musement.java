...
public class Musement extends Locals {
	...
	public void LocalTTDAdult_5540() throws Exception {
		...
		driver.get(locals_Musement_City_URL);
		locals_NameSearch_TTD(driver, dataFile.value("Locals_Musement_collection_name"),
				dataFile.value("Locals_Musement_Activity_Name"));
