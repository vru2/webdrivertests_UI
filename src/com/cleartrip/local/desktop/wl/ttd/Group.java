...
import domainServices.Locals;
	...
	@Test
	public void Locals_WL_TTDGroup_5578() throws Exception {
		  driver.manage().deleteAllCookies();  
	      driver.get(localsWL_City_URL);	
	      locals_NameSearch_TTD(driver, dataFile.value("Locals_Data_Activity_MultiRate_Group"), dataFile.value("Locals_Data_Activity_MultiRate_Name"));
		  locals_BookPopUP(driver, "TTD","Group",1);
		  locals_ItineraryPage(driver,"");
		  locals_PaymentPage(driver, "CC");	
		  locals_Payment_ConfirmationPage(driver, "WL TTD Groups : ", "");
  }
