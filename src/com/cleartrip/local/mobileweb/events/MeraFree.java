...
import domainServices.Locals;
	...
	public class MeraFree extends Locals{
	public RemoteWebDriver driver;

  @Test
  public void LocalsMobileWeb_EventsMeraFree_9015() throws Exception {
	 driver.manage().deleteAllCookies();  
	 //locals_Events_Data_Refresh(driver, "Mera");
	 driver.get(locals_City_Events_URL);
	 locals_NameSearch_MobileWeb_Events(driver, "", dataFile.value("Locals_Data_Events_MeraFree"));
	 locals_BookFlow_MobileWeb(driver, "Events", "MeraFree");
	 locals_ItineraryPage(driver, "Free");
	 locals_Payment_ConfirmationPage_MobileWeb(driver, "MobileWeb Events Mera Free : ", "");
  }
