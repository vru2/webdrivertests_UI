...
import domainServices.Locals;
	...
	public class MeraPaid extends Locals{
	public RemoteWebDriver driver;

  @Test
  public void LocalsMobileWeb_EventsMeraPaid_9014() throws Exception {
	 driver.manage().deleteAllCookies();
	  locals_Events_Data_Refresh(driver, "Mera");
	 driver.get(locals_City_Events_URL);
	 locals_NameSearch_MobileWeb_Events(driver, "", dataFile.value("Locals_Data_Events_MeraPaid"));
	 locals_BookFlow_MobileWeb(driver, "Events", "MeraPaid");
	 locals_ItineraryPage(driver, "");
	 locals_PaymentPage(driver, "CC");
	 locals_Payment_ConfirmationPage_MobileWeb(driver, "MobileWeb Events Mera Paid : ", "");
  }
