...
import domainServices.Locals;
  ...
  public void LocalsMobileWeb_TTD_AdultAE_5561() throws Exception {
	 ...
	 driver.get(locals_Klook_City_URL_AdditionalInfo_WithoutList);	 
	 locals_NameSearch_TTD_MobileWeb(driver, dataFile.value("Locals_Klook_collection_name_AdditionalInfo_WithoutList"),
				dataFile.value("Locals_Klook_Activity_Name_AdditionalInfo_WithoutList"));
