...
import domainServices.Locals;
  ...
  public void LocalsWL_MobileWeb_FNB_AdultChild_6853() throws Exception {
		...
		// locals_PaymentPage(driver, "NBRetryAE");
		 locals_PaymentPage(driver, "CC");
		 locals_Payment_ConfirmationPage_MobileWeb(driver, "WL MobileWeb FNB Adult Child : ", "");
  }
