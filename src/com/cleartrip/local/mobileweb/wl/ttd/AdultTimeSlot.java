...
import domainServices.Locals;
  ...
  @Test
  public void LocalsWL_MobileWeb_TTD_TimeSlot_9019() throws Exception {
	 driver.manage().deleteAllCookies();  
	 driver.get(dataFile.value("Locals_WL_QA2"));
	 locals_Change_Location_MobileWeb_WL(driver);
	 locals_NameSearch_TTD_MobileWeb(driver, dataFile.value("Locals_Data_Activity_Adult_TimeSlot_Group"), dataFile.value("Locals_Data_Activity_Adult_TimeSlot_Name"));
	 locals_BookFlow_MobileWeb(driver, "TTD", "AdultTime");
	 locals_ItineraryPage(driver, "");
	 locals_PaymentPage(driver, "CC");
	 locals_Payment_ConfirmationPage_MobileWeb(driver, "WL MobileWeb TTD Adult TimeSlot: ", "");
  }
