...
import domainServices.Locals;
	...
	public class PerUnitMultiRates extends Locals{
	public RemoteWebDriver driver;

  @Test
  public void LocalsMobileWeb_TTD_PerUnitMultiRates_9023() throws Exception {
    	 driver.manage().deleteAllCookies();  
	     driver.get(dataFile.value("Locals_WL_QA2"));
	     driver.manage().window().maximize();
	     locals_Change_Location_MobileWeb_WL(driver);
	     locals_NameSearch_TTD_MobileWeb(driver, dataFile.value("Locals_Data_Activity_MultiRate_Group"), dataFile.value("Locals_Data_Activity_MultiRate_Name"));
	     locals_BookFlow_MobileWeb(driver, "TTD", "MultiRate");
		 locals_ItineraryPage(driver, "");
		 locals_PaymentPage(driver, "CC");
		 locals_Payment_ConfirmationPage_MobileWeb(driver, "WL MobileWeb TTD Multirates ", "");
  }
