...
import org.testng.annotations.Test;
	...
	public class Air_Emails3 extends excelAir{
...
public void gmailsignin(String TripID, String TripID1, String TripID2, String TripID3, String TripID4, String TripID5) throws Exception {	
	ArrayList<String> db_airTrip = db_airTripDetail(TripID3);
	gmailAirValidation(driver, TripID3, db_airTrip);
  }
  ...
  public void setUp() throws Exception {
	...
	gmailLogin(driver, "cleartriptestforfbautomation@gmail.com", "cleartrip@123");
