...
public class TS_GET_Air_Refunded extends TripserviceCommon{
	...
	Reporter.log("http://172.17.26.11:9031/trips/air/refunded?status=D&fromDate=2019-09-05&toDate=2019-09-12&dbFetchType=REAL_TIME");
	Response resp=RestAssured.get("http://172.17.26.11:9031/trips/air/refunded?status=D&fromDate=2019-09-05&toDate=2019-09-12&dbFetchType=REAL_TIME");
	...
	Reporter.log("http://172.17.26.11:9031/trips/air/refunded?status=D&fromDate=2019-02-02&toDate=2019-04-30&dbFetchType=ARCHIVED");
	Response resp1=RestAssured.get("http://172.17.26.11:9031/trips/air/refunded?status=D&fromDate=2019-01-01&toDate=2019-04-30&dbFetchType=ARCHIVED");
