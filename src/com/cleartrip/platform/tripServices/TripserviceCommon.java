...
public class TripserviceCommon extends PlatformCommonUtil {
	...
	public Response validationforgraphql(Response resp){
		if(resp.statusCode()==200){			
			...
			String bodyAsString = body.asString();
			Assert.assertEquals(bodyAsString.contains("tripRef"), true ,"Response boday contains tripRef");
			Assert.assertEquals(bodyAsString.contains("airlinePnr"), true ,"Response boday contains airlinePnr");
			Assert.assertEquals(bodyAsString.contains("paxInfoId"), true ,"Response boday contains paxInfoId");
			Assert.assertEquals(bodyAsString.contains("agentPcc"), true ,"Response boday contains agentPcc");
    ...
    String params_getalltrip="{\"booking_status\":{\"1\": [\"P\", \"R\", \"C\", \"H\", \"D\", \"Y\", \"L\", \"T\", \"S\",\"W\",\"M\",\"Z\",\"F\",\"E\"], \"2\": [\"W\",\"H\",\"B\",\"P\",\"Z\",\"A\",\"R\",\"T\",\"I\",\"L\"],\"4\": [\"P\",\"H\",\"Z\"],\"16\": [\"P\",\"H\",\"Z\",\"IC\"]},\"channel\": [\"B2C\", \"CORP\", \"CTPHONEBOOKINGS\",\"ACCOUNT\",\"MOBILE\"],\"created_at_date\":\"2018-11-27T00:00:00.000\",\"email_id\":\"varalakshmi.venkateshaiah@cleartrip.com\",\"start_date_time\":\"2018-11-27T00:00:00.000\",\"user_id\": \"41683432\",\"expired\":\"true\"}";
    String params_getupcomingtrip="{\"booking_status\":{\"1\": [\"J\",\"W\",\"B\",\"M\",\"N\",\"T\",\"I\",\"IC\",\"P\",\"A\",\"Q\",\"D\",\"K\",\"O\",\"AA\",\"H\",\"IF\",\"Z\",\"R\",\"C\",\"E\",\"X\",\"F\",\"Y\",\"G\",\"L\",\"U\",\"V\",\"S\"], \"2\": [\"J\",\"W\",\"B\",\"M\",\"N\",\"T\",\"I\",\"IC\",\"P\",\"A\",\"Q\",\"D\",\"K\",\"O\",\"AA\",\"H\",\"IF\",\"Z\",\"R\",\"C\",\"E\",\"X\",\"F\",\"Y\",\"G\",\"L\",\"U\",\"V\",\"S\"],\"4\": [\"J\",\"W\",\"B\",\"M\",\"N\",\"T\",\"I\",\"IC\",\"P\",\"A\",\"Q\",\"D\",\"K\",\"O\",\"AA\",\"H\",\"IF\",\"Z\",\"R\",\"C\",\"E\",\"X\",\"F\",\"Y\",\"G\",\"L\",\"U\",\"V\",\"S\"], \"16\": [\"J\",\"W\",\"B\",\"M\",\"N\",\"T\",\"I\",\"IC\",\"P\",\"A\",\"Q\",\"D\",\"K\",\"O\",\"AA\",\"H\",\"IF\",\"Z\",\"R\",\"C\",\"E\",\"X\",\"F\",\"Y\",\"G\",\"L\",\"U\",\"V\",\"S\"]},\"channel\": [\"B2C\", \"CORP\", \"CTPHONEBOOKINGS\",\"ACCOUNT\",\"MOBILE\"],\"created_at_date\":\"2019-09-23T00:00:00.000Z\",\"email_id\":\"testcltp6@gmail.com\",\"start_date_time\":\"2019-12-31T00:00:00.000\",\"user_id\": \"41699798\",\"expired\":\"false\"}";
    String params_getalltrip_prod="{\"booking_status\":{\"1\": [\"P\", \"R\", \"C\", \"H\", \"D\", \"Y\", \"L\", \"T\", \"S\",\"W\",\"M\",\"Z\",\"F\",\"E\"], \"2\": [\"W\",\"H\",\"B\",\"P\",\"Z\",\"A\",\"R\",\"T\",\"I\",\"L\"],\"4\": [\"P\",\"H\",\"Z\"],\"16\": [\"P\",\"H\",\"Z\",\"IC\"]},\"channel\": [\"B2C\", \"CORP\", \"CTPHONEBOOKINGS\",\"ACCOUNT\",\"MOBILE\"],\"created_at_date\":\"2018-11-27T00:00:00.000\",\"email_id\":\"varalakshmi.venkateshaiah@cleartrip.com\",\"start_date_time\":\"2018-11-27T00:00:00.000\",\"user_id\": \"86627412\",\"expired\":\"true\"}";
    ...
    String tripquery_qa="{'query':'{   trips(id: \"Q190801451288\") { tripRef bookingStatus currency bkgType airBookings { journeyType paxInfos { id firstName lastName} flights { segments { id departureAirport arrivalAirport marketingAirline operatingAirline }} airBookingInfos { airlinePnr id paxInfoId pricingObjectId agentPcc segmentId} pricingObjects { id costPricingObject { id totalFare }} } txns { airCancellations { id splitPnr splitAirlinePnr airBookingInfoId }airRefundRecords { id totalSupCharge  } }  }}'}";
