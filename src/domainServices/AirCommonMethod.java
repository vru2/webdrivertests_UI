...
*/
	...
	public void isSFFEnabled(String tripId) {
	    ...
	    try {
	        ...
	        String statsResponseStr = IOUtils.toString(statsResponse.getEntity().getContent(), StandardCharsets.UTF_8);
		...
		public Map<String, Object> readProperties() throws Exception {
		    ...
		    try {
		        ...
		        properties.load(new StringReader(IOUtils.toString(connectorResponse.getEntity().getContent(), StandardCharsets.UTF_8)));
...
*/
		    ...
		    try {
		        ...
		        for (int index = 0; index < jsonValues.size(); index++) {
		            ...
		            if (res != null) {
		                ...
		                String statsInnerResponseStr = IOUtils.toString(statsInnerResponse.getEntity().getContent(), StandardCharsets.UTF_8);
		...
		public Map<String, Double> getMealBaggageAndPaxPrice(String tripId) throws Exception {
		    ...
		    try {
		        ...
		        String hqResponseStr = IOUtils.toString(hqResponse.getEntity().getContent(), StandardCharsets.UTF_8);
