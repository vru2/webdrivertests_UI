...
import domainServices.PaymentNodeJS;
	...
	public class Payment_NodeJS_Air_Agency_CC extends PaymentNodeJS{
	public RemoteWebDriver driver;
	private String baseUrl;
	
  @Test 
  public void paymentNodeJS_Air_Agency_CC() throws Exception {
	   ...
	   paymentNodeJS_ConfirmationPage(driver, "CC", "","Air Agency CC");
  }
