...
import static commonServices.CachedProperties.cacheUrlInstance;
import static commonServices.CachedProperties.campLocalInstance;
import static commonServices.CachedProperties.ctsuite;
import static commonServices.CachedProperties.dataInstance;
import static commonServices.CachedProperties.dbInstance;
import static commonServices.CachedProperties.getTrip;
import static commonServices.CachedProperties.getapiPayload;
import static commonServices.CachedProperties.instance;
import static commonServices.CachedProperties.objectReportInstance;
import static commonServices.CachedProperties.objectReportInstanceAir;
import static commonServices.CachedProperties.objectReportInstanceHotels;
import static commonServices.CachedProperties.objectReportInstanceHotelsPWA;
import static commonServices.CachedProperties.objectReportInstanceLocals;
import static commonServices.CachedProperties.objectReportInstancePayment;
import static commonServices.CachedProperties.objectReportInstanceTrains;
import static commonServices.CachedProperties.objectReposCtSuite;
import static commonServices.CachedProperties.platformInstance;
import static commonServices.CachedProperties.objectReportInstancePlatform;
import java.io.File;
...
public class CommonUtil extends oracle.jdbc.driver.OracleDriver{
	...
	public CachedProperties objectReposAir = objectReportInstanceAir();
	public CachedProperties objectReposHotels = objectReportInstanceHotels();
	public CachedProperties objectReposHotelsPWA = objectReportInstanceHotelsPWA();
	public CachedProperties objectReposPlatform = objectReportInstancePlatform();
	public CachedProperties objectReposLocals = objectReportInstanceLocals();
	public CachedProperties objectReposTrains = objectReportInstanceTrains();
	public CachedProperties objectReposPayment = objectReportInstancePayment();
	public CachedProperties rubyAPITrips = getTrip();
	public CachedProperties apiPayload = getapiPayload();
	public CachedProperties platform = platformInstance();
	public CachedProperties ctsuite = ctsuite();
	public CachedProperties objectReposCtSuite = objectReposCtSuite();
	public CachedProperties campLocal = campLocalInstance();
