...
public class Accounts extends AirCommonMethod {
	...
	public void Accounts_HomepageSignIn_otp(RemoteWebDriver driver) throws Exception {
		String Host = common.value("host");
		String mainWindow = driver.getWindowHandle();
		Thread.sleep(2000);
		if(!elementVisible(driver, getObject("Acc_Menu_dropdown"), 10)) {
		...
		elementPresent_Time(driver, getObjectHotels("HotelCom_SignIn_ModalWindow_Email"), 50);
		if(Host.equalsIgnoreCase("qa2")) {
			safeType(driver, getObjectHotels("HotelCom_SignIn_ModalWindow_Email"), dataFile.value("AccountsUserName2"));
			safeType(driver, getObjectHotels("HotelCom_SignIn_ModalWindow_Password"), dataFile.value("AccountsPassword"));	
			Thread.sleep(4000);
			safeClick(driver, getObjectHotels("HotelCom_SignIn_ModalWindow_SignIN_Button"));
			Thread.sleep(2000);
	...
	public void DeleteAndReisterSignin(RemoteWebDriver driver) throws Exception {
		...
		elementPresent_Time(driver, getObjectHotels("HotelCom_SignIn_ModalWindow_Email"), 50);
		if(Host.equalsIgnoreCase("qa2")) {
			safeType(driver, getObjectHotels("HotelCom_SignIn_ModalWindow_Email"),"testcltp2@gmail.com");
			Thread.sleep(4000);
	...
	public void resetPassword(RemoteWebDriver driver) throws Exception {
		...
		textAssert(driver, "Check your email to reset your password", 20);
	...
	public void addCardInExpressway(RemoteWebDriver driver) throws Exception {
		...
		if (waitElement(driver, getObject("Acc_Expressway_AddCard"), 3)) {
			Thread.sleep(1000);
			safeType(driver, getObject("Acc_Expressway_CardNo"),"512345");
			Thread.sleep(500);
			driver.findElement(getObject("Acc_Expressway_CardNo")).sendKeys("678");
			Thread.sleep(500);
			driver.findElement(getObject("Acc_Expressway_CardNo")).sendKeys("90");
			Thread.sleep(500);
			driver.findElement(getObject("Acc_Expressway_CardNo")).sendKeys("123");
			driver.findElement(getObject("Acc_Expressway_CardNo")).sendKeys("46");
	...
	public void Accounts_HomepageSignin(RemoteWebDriver driver) throws Exception {
		...
		safeType(driver, getObjectHotels("HotelCom_SignIn_ModalWindow_Password"), dataFile.value("mwpassword1"));	
	...
	public ArrayList<String> MySQL_DB_GETOTP(String email) throws SQLException, ClassNotFoundException {
		ArrayList<String> data = new ArrayList<String>();
		ArrayList<String> Name = new ArrayList<String>();
		{
			
			//jdbc:mysql://localhost:3306/orion_db
				String url = "jdbc:mysql://10.10.4.22:3306/accounts";
			//String url = "jdbc:oracle:thin:@172.17.14.174:3306/payment";
			String user = "cleartrip";
			String password = "1nterl3av3";
			String query =  "select otp,person_id,username from accounts.otp_details inner join accounts.people on accounts.people.id=accounts.otp_details.person_id where accounts.people.username='"+email+"' order by accounts.otp_details.created_at desc";
