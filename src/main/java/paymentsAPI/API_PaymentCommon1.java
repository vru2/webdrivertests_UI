...
/*//OLD mysql apps
	...
	String param_Air_Amendment_API1  = "{\"itinerary_id\":\"68edc4657c-90e5-44bc-8eaf-200612123123\",\"ttl\":0,\"trip_id\":140471948,\"ui_language\":\"EN\",\"client\":\"Cleartrip\",\"trip_ref\":\"";
...
/*	public Response rearch_Smiles(String payType, String payType1){
	...
	public Response payUIget(String payType, String PayType1) throws Exception {
		...
		if(payType.equalsIgnoreCase("BookApp/GetPay")){
			...
			RestAssured.baseURI = urlPay;
			endPoint = endPointgetPay;	
			params = param_Air_Amendment_API1+getNewDate_TripID()+param_Air_Amendment_API2;
		}
		else if(payType.equalsIgnoreCase("AirAE")){
			RestAssured.baseURI = urlPay;
			endPoint = endPointgetPay;	
			params = params_PayUI_Air1+getNewDate_TripID()+params_PayUI_Air_AE;
		}else if(payType.equalsIgnoreCase("AirBH")){
			RestAssured.baseURI = urlPay;
			endPoint = endPointgetPay;	
			params = params_PayUI_Air1+getNewDate_TripID()+params_PayUI_Air_BH;
		}else if(payType.equalsIgnoreCase("AirKW")){
			RestAssured.baseURI = urlPay;
			endPoint = endPointgetPay;	
			params = params_PayUI_Air1+getNewDate_TripID()+params_PayUI_Air_KW;
		}else if(payType.equalsIgnoreCase("AirSA")){
			RestAssured.baseURI = urlPay;
			endPoint = endPointgetPay;	
			params = params_PayUI_Air1+getNewDate_TripID()+params_PayUI_Air_SA;
		}else if(payType.equalsIgnoreCase("AirOM")){
			RestAssured.baseURI = urlPay;
			endPoint = endPointgetPay;	
			params = params_PayUI_Air1+getNewDate_TripID()+params_PayUI_Air_OM;
		}else if(payType.equalsIgnoreCase("AirQA")){
			RestAssured.baseURI = urlPay;
			endPoint = endPointgetPay;	
			params = params_PayUI_Air1+getNewDate_TripID()+params_PayUI_Air_QA;
		}else if(payType.equalsIgnoreCase("AirUS")){
			RestAssured.baseURI = urlPay;
			endPoint = endPointgetPay;	
			params = params_PayUI_Air1+getNewDate_TripID()+params_PayUI_Air_US;
		}
			response = RestAssured.given().
