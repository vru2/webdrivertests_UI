...
/*//OLD mysql apps
	...
	String Paramsadcb_checkbalance2 = "\",  \"cardNumber\": \"5264084466545740\",  \"amount\": 0.01,  \"currency\": \"AED\",   \"params\": {     \"customerName\": \"test\",     \"expiryDate\": \"2506\"  }}";
	String Paramsadcb_sendOTP1 = "{  \"rewardsType\": \"ADCB\",  \"rewardsRequestType\": \"OTP\",  \"trackId\": \"";
	String Paramsadcb_sendOTP2 = "\",  \"cardNumber\": \"5264084466545740\",  \"amount\": 0.01,  \"currency\": \"AED\",  \"params\": {  \t \"customerName\": \"test\",     \"expiryDate\": \"2506\"  }}";
	...
	String Paramsadcb_validate2=  "\",            \"otp\":\"11111111\",            \"bankName\": \"ADCB\",            \"card_detail\":{               \"card_number\":\"5264084466545740\",               \"card_type_id\":2,               \"expiry_month\":\"06\",               \"expiry_year\":\"2506\",               \"cvv\":\"123\",               \"name\":\"Test\",               \"billto_detail\":{                  \"firstname\":\"Test\",                  \"address1\":\" \",                  \"city_name\":\"\",                  \"state_name\":\"\",                  \"country_name\":\"\",                  \"postal_code\":\"\"               }            }         }      }   }]";
...
/*	public Response rearch_Smiles(String payType, String payType1){
	...
	public Response reward(String payType, String PayType1) throws Exception {
		...
		if(payType.equalsIgnoreCase("ADCB_CheckBalance")) {
			...
			params = "{\"rewardsType\":\"PAYBACK\",\"rewardsRequestType\":\"REDEEM\",\"paymentId\": " +payment_id_redeem+ ",\"trackId\": \"" + track_id + "\","+ "\"amount\":1,\"currency\":\"INR\",\"params\":{\"mobile\":\"9986696785\",\"tripRef\":\"Q191014530822\",\"pin\":\"5572\"}}";
