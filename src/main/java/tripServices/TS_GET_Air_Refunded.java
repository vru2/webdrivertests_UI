...
public class TS_GET_Air_Refunded extends TripserviceCommon{
	...
	Reporter.log("http://172.17.26.11:9031/trips/air/refunded?status=D&fromDate=2019-10-29&toDate=2019-12-03&dbFetchType=REAL_TIME");
	Response resp=RestAssured.get("http://172.17.26.11:9031/trips/air/refunded?status=D&fromDate=2019-10-29&toDate=2019-12-03&dbFetchType=REAL_TIME");
