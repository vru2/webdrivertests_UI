...
public class Accounts_FetchtripdetailsByBookedUserid extends TripserviceCommon {
	...
	public void Accounts_FetchByBookedUserid() throws Exception{
		Response resp;
		Response resp1;
		String url_prod="http://trip-service.cltp.com:9001/api/trips/fetch-trip-details?bookedUserId=86627412&size=1";
		String url1_prod="http://trip-service.cltp.com:9001/api/trips/fetch-trip-details?bookedUserId=86627412&size=10";
