...
public class TripserviceCommon extends PlatformCommonUtil {
	...
	public Response TripserviceTripQuery(String tripquery_prod, HashMap<String, Object> headers, String url){
		Response resp;
				resp=RestAssured.given().
						when().
						log().all().
