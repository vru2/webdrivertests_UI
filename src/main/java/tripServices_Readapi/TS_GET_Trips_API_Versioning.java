...
public class TS_GET_Trips_API_Versioning extends TripserviceCommon {
	...
	public void getTripService(){
		...
		String url1=tsendpoint+gettrip1;
		Reporter.log(url1);
		...
		String url2=tsendpoint+gettrip2;
		Reporter.log(url2);
		...
		String url3=tsendpoint+gettrip3;
		Reporter.log(url3);
		...
		String url4=tsendpoint+gettrip4;
		Reporter.log(url4);
		...
		String url5=tsendpoint+gettrip5;
		Reporter.log(url5);
