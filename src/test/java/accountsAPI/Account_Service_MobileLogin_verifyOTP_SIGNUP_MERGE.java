...
public class Account_Service_MobileLogin_verifyOTP_SIGNUP_MERGE extends AccountsCommon_API  {

	@Test
	public void Account_Service_Update_User_MobileNo_OTPValidaion() throws IOException,JSONException
	{
		Response resp;
		resp = postCall("Account_Service_MobileLogin_verifyOTP_SIGNUP_MERGE","");
