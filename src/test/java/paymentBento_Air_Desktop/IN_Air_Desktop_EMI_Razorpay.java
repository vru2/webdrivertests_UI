...
public class IN_Air_Desktop_EMI_Razorpay extends PaymentsUI_Common_Desktop_Air {
    ...
    @Test
    public void Air_Desktop_EMI_Razorpay() throws Exception {
       ...
       driver.get(air_SRPUrl("IN",origin,destination, date));
        ...
        air_PaymentPage_Desktop(driver,"EMI","RAZORPAY","","EMI","", "EMI Razorpay : " );
    }
