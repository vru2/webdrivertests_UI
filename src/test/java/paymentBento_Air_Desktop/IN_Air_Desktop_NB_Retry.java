...
public class IN_Air_Desktop_NB_Retry extends PaymentsUI_Common_Desktop_Air {
    ...
    @Test
    public void Air_Desktop_NBRetry() throws Exception {
        ...
        air_PaymentPage_Desktop(driver,"NB","","","Retry","", "NB Retry : ");
    }
