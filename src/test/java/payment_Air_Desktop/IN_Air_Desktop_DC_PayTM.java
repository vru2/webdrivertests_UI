...
public class IN_Air_Desktop_DC_PayTM extends PaymentsUI_Common_Desktop_Air {
    ...
    @Test
    public void Air_Desktop_DC_PayTm() throws Exception {
       ...
       driver.get(air_SRPUrl("IN",origin,destination, date));
        ...
        air_PaymentPage_Desktop(driver,"CC","4111","","","", "4111 card DC ");
    }
