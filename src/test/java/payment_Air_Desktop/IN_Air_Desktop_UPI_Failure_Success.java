...
public class IN_Air_Desktop_UPI_Failure_Success extends PaymentsUI_Common_Desktop_Air {
    ...
    @Test
    public void Air_Desktop_UPI_Failure_Sucess() throws Exception {
        ...
        air_PaymentPage_Desktop(driver, "UPI", "", "", "Failure", "", "UPI failure : ");  // failure case
        air_PaymentPage_Desktop(driver, "UPI", "", "", "", "", "UPI : ");
    }
