...
public class Air_Web_PayLater extends PaymentsUI_Common_Desktop_Air {
    ...
    @Test
    public void Air_Desktop_Paylater() throws Exception {
       ...
       driver.get(air_SRPUrl1("IN",origin,destination, date));
        ...
        air_PaymentPage_Desktop(driver,"PAYLATER","RAZORPAY","","","", "PayLater Razorpay : ");
    }
