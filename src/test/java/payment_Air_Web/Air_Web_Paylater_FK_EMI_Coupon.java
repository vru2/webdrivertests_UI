...
public class Air_Web_Paylater_FK_EMI_Coupon extends PaymentsUI_Common_Desktop_Air {
    ...
    @Test
    public void Air_Desktop_FKPL_EMI_Coupon() throws Exception {
        ...
        air_PaymentPage_Desktop(driver,"PAYLATERFK","","","PaylaterEMI","COUPON", "PayLater EMI FK Coupon : ");
    }
