...
public class IN_Hotels_PWA_Coupon_Invalid extends PaymentsUI_Common_PWA_Hotels {
    ...
    @Test
    public void Hotel_PWA_Coupon_Invalid() throws Exception {
        ...
        bento_Paymentpage_PWA(driver,"NB","","Hotel","Coupon","RazorpayNB", "Success");
