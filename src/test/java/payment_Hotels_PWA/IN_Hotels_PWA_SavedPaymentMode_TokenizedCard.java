...
public class IN_Hotels_PWA_SavedPaymentMode_TokenizedCard extends PaymentsUI_Common_PWA_Hotels {
    ...
    @Test
    public void Hotel_PWA_Tokenisedcard() throws Exception {
        ...
        hotels_ConfirmationPage(driver, "","", "Hotel PWA tokenized card");
    }
