...
public class Bento_KW_KNet_Booking extends PaymentsBento_Itn_Common {
	...
	public void bento_kw_booking() throws Exception {
		...
		driver.navigate().to(kwurl+searchurl);
		System.out.println(kwurl+searchurl);
