...
public class Validation_Text_OM extends PaymentUI_Common_Bento{
	...
	public void CC_Validation_Text() throws Exception {
		get_Bento_Url(driver, "AirOM", "OM");
		bento_Validation_Text(driver, "CC", "");
		bento_Validate_Currency(driver, "OM", "OMR");
	}
...
/*	@Test (priority=2)
	...
	public void PriceBreakUP_Validation_Text() throws Exception {
		bento_Validation_Text(driver, "PRICE_BREAKUP", "OM");
	}	
	
	@Test (priority=3)
	public void BookingSummary_Validation_Text() throws Exception {
		bento_Validation_Text(driver, "Booking_SUMMARY", "OM");	
	}
