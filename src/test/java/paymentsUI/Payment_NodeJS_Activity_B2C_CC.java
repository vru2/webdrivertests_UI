...
import test.java.domains.PaymentNodeJS;
	...
	public class Payment_NodeJS_Activity_B2C_CC extends PaymentNodeJS{
	public RemoteWebDriver driver;
	private String baseUrl;
	
  @Test 
  public void paymentNodeJS_Acty_B2C_CC() throws Exception {
	   ...
	   paymentNodeJS_ConfirmationPage(driver, "CC", "","Activity B2C CC");
  }
