...
import test.java.domains.PaymentNodeJS;
	...
	public class Payment_NodeJS_CTWallet_CC_AE extends PaymentNodeJS{
	public RemoteWebDriver driver;
	private String baseUrl;
	
  @Test 
  public void paymentNodeJS_CTWALL_CCAE() throws Exception {
       driver.manage().deleteAllCookies(); 
	   driver.get(baseUrl);	   
	   paymentNodeJS_Select_Payment(driver, "CURRENCY", "AED", "");
	//   paymentNodeJS_Select_Payment(driver, "CTCC", "NOHOMEPAGE", "");
