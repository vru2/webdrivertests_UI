...
import test.java.domains.PaymentNodeJS;
	...
	public class Payment_NodeJS_GV_CC extends PaymentNodeJS{
  ...
  public void paymentNodeJS_GV() throws Exception {
	   ...
	   driver.get(baseUrl);	   
	   paymentNodeJS_Select_Payment(driver, "GVCC", "", common.value("testcardtype"));
	   paymentNodeJS_Make_Payment(driver, "CC", common.value("testcardtype"));
	   paymentNodeJS_ConfirmationPage(driver, "CC", "","GV + CC ");
  }
