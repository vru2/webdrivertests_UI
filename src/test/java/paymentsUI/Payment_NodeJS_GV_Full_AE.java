...
import test.java.domains.PaymentNodeJS;
	...
	public class Payment_NodeJS_GV_Full_AE extends PaymentNodeJS{
	public RemoteWebDriver driver;
	private String baseUrl;
	
  @Test 
  public void paymentNodeJS_GVAE() throws Exception {
       driver.manage().deleteAllCookies(); 
	   driver.get(baseUrl);	   
	   paymentNodeJS_Select_Payment(driver, "CURRENCY", "AED", "");
	   add_GV(driver, "");
	   safeClick(driver, getObjectPayment("SelectPayment_GV_Full_Btn"));
	 // paymentNodeJS_Select_Payment(driver, "GV", "NOHOMEPAGE", "");
	   paymentNodeJS_Make_Payment(driver, "GV", "");
	   paymentNodeJS_ConfirmationPage(driver, "GV", "","GV Full AE ");
  }
