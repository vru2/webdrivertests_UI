...
import test.java.domains.PaymentNodeJS;
	...
	public class Payment_NodeJS_Hotels_Corp_CC extends PaymentNodeJS{
	public RemoteWebDriver driver;
	private String baseUrl;
	
  @Test 
  public void paymentNodeJS_Hotel_Corp_CC() throws Exception {
       driver.manage().deleteAllCookies(); 
	   driver.get(baseUrl);	   
	   paymentNodeJS_HomePage(driver, "", "");
	   paymentNodeJS_Select_Source(driver, "CORP", "");
	   ...
	   paymentNodeJS_ConfirmationPage(driver, "CC", "","Hotel CORP CC");
  }
