...
import test.java.domains.PaymentNodeJS;
	...
	public class Payment_NodeJS_Hotels_Mobile_CC extends PaymentNodeJS{
	public RemoteWebDriver driver;
	private String baseUrl;
	
  @Test 
  public void paymentNodeJS_Hotel_Mobl_CC() throws Exception {
	   ...
	   paymentNodeJS_ConfirmationPage(driver, "CC", "","Hotel Mobile CC");
  }
