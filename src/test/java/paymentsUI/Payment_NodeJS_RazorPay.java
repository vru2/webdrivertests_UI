...
import test.java.domains.PaymentNodeJS;
	...
	public class Payment_NodeJS_RazorPay extends PaymentNodeJS{
  ...
  public void paymentNodeJS_PhonePe() throws Exception {
	   ...
	   driver.get(baseUrl);	   
	   paymentNodeJS_Select_Payment(driver, "RAZORPAY", "", "");
	   paymentNodeJS_Make_Payment(driver, "RAZORPAY", "");
	   paymentNodeJS_ConfirmationPage(driver, "RAZORPAY", "","RAZORPAY  ");
  }
