...
import domains.PaymentNodeJS;
  ...
  @Test
  public void paymentNodeJS_PWA_UI_NB() throws Exception {
	  pwapaymentUI_Setup(); 
	  driver=(RemoteWebDriver) getMobileDriver(driver);
	  driver.manage().deleteAllCookies(); 
	  driver.get(paymentUIurl);	   
	  paymentUI_PWA_Select_Payment(driver, "NB", "Citibank", "");
	  paymentUI_PWA_Make_Payment(driver, "NB", "Citibank");
	  paymentUI_PWA_ConfirmationPage(driver, "NBCiti", "","");
  }
