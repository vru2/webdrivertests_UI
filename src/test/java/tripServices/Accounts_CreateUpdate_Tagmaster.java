...
public class Accounts_CreateUpdate_Tagmaster extends TripserviceCommon {
	...
	public void Accounts_ExistingUsers() throws Exception{
		Response resp;
		Response resp1;
		String url="http://trip-service-api.cltp.com:9001/api/trips/company-tag";
