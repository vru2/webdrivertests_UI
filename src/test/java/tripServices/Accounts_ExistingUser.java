...
public class Accounts_ExistingUser extends TripserviceCommon {
	...
	public void Accounts_ExistingUsers() throws Exception{
		Response resp;
		Response resp1;
		String url_qa="http://172.17.51.86:9031/api/trips/existing-user?userId=41695410";
		String url1_qa="http://172.17.51.86:9031/api/trips/existing-user?emailId=varalakshmivaru29@gmail.com";
			Reporter.log(url_qa);
