...
public class Accounts_FetchtripdetailsByPersonid extends TripserviceCommon{
	...
	public void Accounts_FetchByPersonid() throws Exception{
		Response resp;
		Response resp1;
		String url_qa="http://trip-service-api.cltp.com:9001/api/trips/fetch-trip-details?personId=41690278&size=1";
		String url1_qa="http://trip-service-api.cltp.com:9001/api/trips/fetch-trip-details?personId=41690278&size=10";
