...
public class Accounts_FetchtripdetailsByUserid extends TripserviceCommon{
	...
	public void Accounts_FetchByUserid() throws Exception{
		Response resp;
		Response resp1;
		String url_qa="http://trip-service-api.cltp.com:9001/api/trips/fetch-trip-details?userId=41697596&size=10";
		String url1_qa="http://trip-service-api.cltp.com:9001/api/trips/fetch-trip-details?userId=41656838&page=4&size=10";
			Reporter.log(url_qa);
