...
public class TS_Affiliated_TxnID extends TripserviceCommon {
	...
	public void getTripService(){
		Reporter.log("http://trip-service-api.cltp.com:9001/trips/affiliate-txn-id?affiliateTxnId=1");
		Response resp=RestAssured.get("http://trip-service-api.cltp.com:9001/trips/affiliate-txn-id?affiliateTxnId=1");
