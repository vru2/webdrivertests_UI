...
public class TS_GET_Air_Refunded extends TripserviceCommon{
	...
	if(resp.statusCode()==200){
		...
		assertTrue(false);
			 ...
			 * "http://trip-service-api.cltp.com:9001/trips/air/refunded?status=D&fromDate=2019-02-02&toDate=2019-04-30&dbFetchType=ARCHIVED"
			 * ); Response resp1=RestAssured.get(
			 * "http://trip-service-api.cltp.com:9001/trips/air/refunded?status=D&fromDate=2019-01-01&toDate=2019-04-30&dbFetchType=ARCHIVED"
