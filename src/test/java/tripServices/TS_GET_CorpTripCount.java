...
public class TS_GET_CorpTripCount extends TripserviceCommon {
	...
	public void getCorpTripCount() throws IOException, InterruptedException{
		...
		Reporter.log("http://172.17.51.86:9031/api/trips?airline-pnr=NZSILX");
		Response resp=RestAssured.get("http://172.17.51.86:9031/api/trips?airline-pnr=NZSILX");
		...
		Reporter.log("http://172.17.51.86:9031/api/trips?domain=automationqa2pta.cleartripforbusiness.com");
		Response resp1=RestAssured.get("http://172.17.51.86:9031/api/trips?domain=automationqa2pta.cleartripforbusiness.com");
		...
		Reporter.log("http://172.17.51.86:9031/api/trips?domain=automationqa2pta.cleartripforbusiness.com&booking-status=P&status-history=4128");
		Response resp2=RestAssured.get("http://172.17.51.86:9031/api/trips?domain=automationqa2pta.cleartripforbusiness.com&booking-status=P&status-history=4128");
		...
		Reporter.log("http://172.17.51.86:9031/api/trips?domain=automationqa2pta.cleartripforbusiness.com&airline-pnr=VXZVKS&booking-status=P&status-history=4128&gds-pnr=5T6N3M&txn-status=C&booker-id=4172698&pax-id=55370546");
		Response resp3=RestAssured.get("http://172.17.51.86:9031/api/trips?domain=automationqa2pta.cleartripforbusiness.com&airline-pnr=VXZVKS&booking-status=P&status-history=4128&gds-pnr=5T6N3M&txn-status=C&booker-id=4172698&pax-id=55370546");
