...
public class TS_GET_CorpTripList extends TripserviceCommon {
	...
	public void getCorpTripCount() throws IOException, InterruptedException{
		...
		/*	Reporter.log("http://trip-service.cltp.com:9001/api/trips/corp?domain=corpprod.cleartripforbusiness.com&booking-status=Z&status-history=4128&txn-status=C&booker-id=74797002");
			Response resp4=RestAssured.get("http://trip-service.cltp.com:9001/api/trips/corp?domain=corpprod.cleartripforbusiness.com&booking-status=Z&status-history=4128&txn-status=C&booker-id=74797002");
