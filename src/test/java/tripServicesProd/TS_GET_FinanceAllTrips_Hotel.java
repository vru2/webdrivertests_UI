...
public class TS_GET_FinanceAllTrips_Hotel extends TripserviceCommon {
	...
	public void getTripService() throws IOException{
		String url="http://trip-service.cltp.com:9001/trips/finance/all-trips?date=2019-08-01&productType=hotel&txnType=1&paymentStatus=SUCCESS&domains=cleartrip.com%24";
