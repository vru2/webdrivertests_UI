...
public class TS_Get_TripDetails_CommValue extends TripserviceCommon {
	...
	public void phoneasCommunicationValue() throws Exception{
		Response resp;
		String url = "http://trip-service.cltp.com:9001/api/trips/PHONE/1234567890?size=20&dbFetchType=REAL_TIME";
	...
	public void emailasCommunicationValue() throws Exception{
		Response resp1;
		Thread.sleep(2000);
	    String url1="http://trip-service.cltp.com:9001/api/trips/EMAIL/varalakshmi.venkateshaiah@cleartrip.com?size=20&dbFetchType=REAL_TIME";
