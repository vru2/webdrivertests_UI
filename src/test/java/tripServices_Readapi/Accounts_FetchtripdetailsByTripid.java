...
public class Accounts_FetchtripdetailsByTripid extends TripserviceCommon {
	...
	public void Accounts_FetchByTripid() throws Exception{
		...
		Response resp2;
		Response resp3;
		String url_air=tsendpoint+fetchtripdeatilsByTripidAir;
		String url_hotel=tsendpoint+fetchtripdeatilsByTripidHotel;
		String url_local=tsendpoint+fetchtripdeatilsByTripidLocal;
		String url_train=tsendpoint+fetchtripdeatilsByTripidTrain;
