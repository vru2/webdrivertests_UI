...
public class TripserviceCommon extends PlatformCommonUtil {
	...
	String depositaccount1="/api/trips/deposit-account-details?id=46206142";
	String existingusers="/api/trips/existing-user?userId=41695410";
	String existingusers1="/api/trips/existing-user?emailId=varalakshmivaru29@gmail.com";
	String fetchtripdetailsByBookedUserid="/api/trips/fetch-trip-details?bookedUserId=41656838&size=1";
	String fetchtripdetailsByBookedUserid1="/api/trips/fetch-trip-details?bookedUserId=41697596&size=10";
	String fetchtripdetailsByPersonid="/api/trips/fetch-trip-details?personId=41690278&size=1";
	String fetchtripdetailsByPersonid1="/api/trips/fetch-trip-details?personId=41690278&size=10";
	String fetchtripdeatilsByTripidAir="/api/trips/fetch-trip-details?tripId=46201038&size=1";
	String fetchtripdeatilsByTripidHotel="/api/trips/fetch-trip-details?tripId=46202808&size=1";
	String fetchtripdeatilsByTripidLocal="/api/trips/fetch-trip-details?tripId=46089500&size=1";
	String fetchtripdeatilsByTripidTrain="/api/trips/fetch-trip-details?tripId=45967650&size=1";
	String fetchtripdeatilsByTriprefAir="/api/trips/fetch-trip-details?tripRef=Q191112572612&size=1";
	String fetchtripdeatilsByTriprefHotel="/api/trips/fetch-trip-details?tripRef=Q191114574380&size=1";
	String fetchtripdeatilsByTriprefLocal="/api/trips/fetch-trip-details?tripRef=Q191003516082&size=1";
	String fetchtripdeatilsByTriprefTrain="/api/trips/fetch-trip-details?tripRef=Q190814464246&size=1";
	String fetchtripdeatilsByUserid="/api/trips/fetch-trip-details?userId=41697596&size=10";
	String fetchtripdeatilsByUserid1="/api/trips/fetch-trip-details?userId=41656838&page=4&size=10";
	String notes="/api/trips/notes?id=57046380";
	String tagmaster="/api/trips/tag-master?tagMasterId=233256236";
	String tagmaster1="/api/trips/tag-master?tagMasterId=233166322";
	String tagmaster2="/api/trips/tag-master?tagMasterId=233226280";
	String tagmaster3="/api/trips/tag-master?tagMasterId=233266298";
	String taskcategory="/api/trips/task-category?id=5159615";
	String taskcategory1="/api/trips/task-category?companyId=140329";
	String affiliatedtxnid="/trips/affiliate-txn-id?affiliateTxnId=1";
	String couponvalidation="/commonservice/trips/coupons/validation?couponCodes=DOMOW&count=1&usageCountRequired=false";
	String gdspnr="/trips/gds-pnr/VJ5MZD";
	String airrefundedrealtime="/trips/air/refunded?status=D&fromDate=2019-10-29&toDate=2019-12-03&dbFetchType=REAL_TIME";
	String airrefundedarchived="/trips/air/refunded?status=D&fromDate=2019-01-01&toDate=2019-04-30&dbFetchType=ARCHIVED";
	String cancelleddetails="/trips/cancelledDetails?date=06-10-2020&productType=air";
	String cancelledinsurance="/trips/cancelledInsurances?date=09-26-2019";
	String corptripcount="/api/trips?airline-pnr=NZSILX";
	String corptripcount1="/api/trips?domain=automationqa2pta.cleartripforbusiness.com";
	String corptripcount2="/api/trips?domain=automationqa2pta.cleartripforbusiness.com&booking-status=P&status-history=4128";
	String corptripcount3="/api/trips?domain=automationqa2pta.cleartripforbusiness.com&airline-pnr=VXZVKS&booking-status=P&status-history=4128&gds-pnr=5T6N3M&txn-status=C&booker-id=4172698&pax-id=55370546";
	String corptriplist="/trips/corp?domain=demo.cleartripforbusiness.com";
	String corptriplist1="/trips/corp?domain=demo.cleartripforbusiness.com&booking_status=P";
	String corptriplist2="/trips/corp?domain=demo.cleartripforbusiness.com&booker-id=1876970";
	String corptriplist3="/trips/corp?domain=demo.cleartripforbusiness.com&trip-ref=Q190822470014&booker-id=1876970&travel-start-date=2019-09-05&travel-end-date=2019-09-07&booking-date-from=2019-08-21&booking-date-to=2019-08-23&status-history=4096&booking-status=B&pax-id=1876970&initiator-id=1876970&txn-status=C&page-size=10";
	String corptriplist4="/trips/corp?domain=demo.cleartripforbusiness.com&booker-id=1876970&status-history=4096&booking-status=B&txn-status=C";
	String refundeddetails="/trips/refundedDetails?date=07-20-2019&productType=air";
	String commvalue="/api/trips/PHONE/1234567890?size=20&dbFetchType=REAL_TIME";
	String commvalue1="/api/trips/EMAIL/testcltp6@gmail.com?size=20&dbFetchType=REAL_TIME";
	String gettriparchived="/trips?tripID=Q1902280427&refundRequired=true&historyRequired=true&paymentsRequired=true&apiVersion=V1";
	String gettriparchived1="/trips?tripID=Q1902280427&refundRequired=true&historyRequired=true&paymentsRequired=false&apiVersion=V1";
	String gettriparchived2="/trips?tripID=Q1902280427&refundRequired=true&historyRequired=true&paymentsRequired=true&apiVersion=V2";
	String gettriparchived3="/trips?tripID=Q1902280427&refundRequired=true&historyRequired=true&paymentsRequired=false&apiVersion=V2";
	String gettriparchived4="/trips?tripID=Q1902280427&refundRequired=true&historyRequired=true&paymentsRequired=true&apiVersion=V3";
	String gettriparchived5="/trips?tripID=Q1902280427&refundRequired=true&historyRequired=true&paymentsRequired=false&apiVersion=V3";
	String gettrip="/trips?tripID=Q190903480280&refundRequired=true&historyRequired=true&paymentsRequired=true&apiVersion=V1";
	String gettrip1="/trips?tripID=Q190903480280&refundRequired=true&historyRequired=true&paymentsRequired=false&apiVersion=V1";
	String gettrip2="/trips?tripID=Q190903480280&refundRequired=true&historyRequired=true&paymentsRequired=true&apiVersion=V2";
	String gettrip3="/trips?tripID=Q190903480280&refundRequired=true&historyRequired=true&paymentsRequired=false&apiVersion=V2";
	String gettrip4="/trips?tripID=Q190903480280&refundRequired=true&historyRequired=true&paymentsRequired=true&apiVersion=V3";
	String gettrip5="/trips?tripID=Q190903480280&refundRequired=true&historyRequired=true&paymentsRequired=false&apiVersion=V3";
	String gettrips="/trips?tripID=Q1902050303";
	String producttypeuseridair="/api/trips/AIR/41683432?startDateTime=2020-03-01T00:00:00.000+0530&endDateTime=2020-04-08T12:00:00.000+0530";
	String producttypeuseridhotel="/api/trips/HOTEL/41683432?startDateTime=2020-03-01T00:00:00.000+0530&endDateTime=2020-04-08T12:00:00.000+0530";
	String producttypeuseridlocal="/api/trips/LOCAL/41683432?startDateTime=2020-03-01T00:00:00.000+0530&endDateTime=2020-04-08T12:00:00.000+0530";
	String producttypeuseridtrain="/api/trips/TRAIN/41683432?startDateTime=2019-01-01T00:00:00.000+0530&endDateTime=2020-04-08T12:00:00.000+0530";
	String triplockexpiry="/trips/delay-lock-expiry/Q191218623804/200";
	String update="/trips";
	String updatequery="/trips/query";
	String triplist="/api/trips?size=20";
	String pahcomm="/trips/pahCommQueue/Q190607221090";
	String getemail="/trips/email/74979518";
	String graphql="/graphql";
	String tripcount="/users/trips_count/41683432";
	String tripcountpnr="/api/trips?domain=cleartrip.com&airlinePNR=MEQUFA";
	String supplier="/trips/supplier?statusList=P&supplierNames=AMD&toDate=2019-06-01&fromDate=2019-06-30";
	String producttypebooktype="/api/trips/domain-data/AIR/D?travelDate=2020-11-10&domains=cleartrip.com&direction=ASC&size=20&property=ID";
	String financescrapers="/trips/finance/scrapers";
	String companybookstat="/trips/company/bookstat?tripID=Q1903120142";
	String financeair="/trips/finance?fromDate=2019-09-01&toDate=2019-09-10&productType=air&txnType=1&paymentStatus=SUCCESS&domains=cleartrip.com%24";
	String financehotel="/trips/finance?fromDate=2019-09-01&toDate=2019-09-10&productType=hotel&txnType=1&paymentStatus=SUCCESS&domains=cleartrip.com%24";
	String financelocal="/trips/finance?fromDate=2019-09-01&toDate=2019-09-10&productType=local&txnType=1&paymentStatus=SUCCESS&domains=cleartrip.com%24&excludedDomains=cleartrip.ae%5E%24";
    String financealltripsair="/trips/finance/all-trips?date=2019-09-01&productType=air&txnType=1&paymentStatus=SUCCESS&domains=cleartrip.com%24";
    String financealltripshotel="/trips/finance/all-trips?date=2019-08-01&productType=hotel&txnType=1&paymentStatus=SUCCESS&domains=cleartrip.com%24";
    String financealltripslocal="/trips/finance/all-trips?date=2019-08-01&productType=local&txnType=1&paymentStatus=SUCCESS&domains=cleartrip.com%24&excludedDomains=cleartrip.ae%5E%24";
    String tripsitineraryid="/trips/itinerary/68bc020197-2524-46b3-9421-11874efb046a";
