...
import domainServices.Agency;
		...
		public class AgencyAir_DataValidation_Dom_OneWay_GDS extends Agency{
		public RemoteWebDriver driver;

		@Test ( dataProviderClass = AgencyDataProvider.class,dataProvider="AirAgencyDom", groups="Regression")	  
		public void AgencyComOWLCCDataVal_299(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Pref_Airline, String Payment_Type,  String Trip_Logger_Msg, String Booking_Confirmation_Message) throws Exception {
			...
			ArrayList<String> HQ_Data = new ArrayList<String>();
			  ...
			  String SRP_URL = agencyAir_SrpUrl(driver, FromCity, ToCity, Adults, Childrens, Infants, "DomOW", "", 50, 51);
			  driver.get(SRP_URL);
			  /*
			...
			*/ 
			  SRP_Data = agencyCom_DataVal_Dom_SRP(driver, "GDS", SRP_Data);	 			  		
