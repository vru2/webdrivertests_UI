...
import domainServices.Agency;
		...
		public class AgencyAir_DataValidation_Int_OneWay_LCC extends Agency{
		public RemoteWebDriver driver;

		@Test ( dataProviderClass = AgencyDataProvider.class,dataProvider="AirAgencyIntOneway", groups="Regression")	  
		public void AgencyComOWLCCDataVal_303(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Pref_Airline, String Payment_Type,  String Trip_Logger_Msg, String Booking_Confirmation_Message) throws Exception {
			...
			String SRP_URL = agencyAir_SrpUrl(driver, FromCity, ToCity, Adults, Childrens, Infants, "IntlOW", "", 53, 54);	
			driver.get(SRP_URL);	
			  SRP_Data = agencyCom_DataVal_Intl_SRP(driver, "LCC", SRP_Data);	 			  		
			...
			//  HQ_Data = agencyCom_DataVal_HQ_Intl(driver, SRP_Data, PaymentPage_Data, ConfirmationPage_Data, HQ_Data, TripID);
		}
