...
import domainServices.Agency;
		...
		public class AgencyAir_Int_Hold_Confirm extends Agency{
		public RemoteWebDriver driver;
		String TripID = null;
		
		@Test ( dataProviderClass = AgencyDataProvider.class,dataProvider="AirAgencyIntHoldOneway", groups="Regression")	  
		public void AgencyComInt_HoldConfirm_295(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Pref_Airline, String Payment_Type,  String Trip_Logger_Msg, String Booking_Confirmation_Message) throws Exception {
		  ...
		  if(MakePaymentOnlyInQA2){
			...
			textAssert(driver, By.xpath("//tr[3]/td[2]"), "Confirmed");
			driver.manage().deleteAllCookies();
			...
			textAssert(driver, By.xpath("//table[2]/tbody/tr[3]/td[2]"), "Confirmed");
		  }
		}
