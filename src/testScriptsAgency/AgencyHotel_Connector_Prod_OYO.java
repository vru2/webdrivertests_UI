...
import domainServices.AgencyHotels;
	...
	public class AgencyHotel_Connector_Prod_OYO extends AgencyHotels{
	public RemoteWebDriver driver;
	String TripID = null;
	
  @Test ( dataProviderClass = AgencyDataProvider.class,dataProvider="HotelAgency", groups="Regression")
  public void agencyHotel_Prod_OYO(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, 
	  ...
	  String HotelB2B_OYO = null;
	   if(ProductionUrl) {
	    ...
	    agencyHotel_SrpUrl_HotelName(driver, "Mumbai", "Maharashtra", "IN", "1", 50, 51 , HotelB2B_OYO);		
	  /*	driver.get(Agency_Url());
		...
		*/agencyHotel_SRP(driver, "","");
		...
		agencyHotel_Paymentpage(driver, "NETBANKINGPROD", "", "Agency OYO Connector NB Retry  :", Booking_Confirmation_Message);
	}
