...
import domainServices.AgencyHotels;
	...
	public class AgencyHotel_DetailsPageBook extends AgencyHotels{
	public RemoteWebDriver driver;

  @Test ( dataProviderClass = AgencyDataProvider.class,dataProvider="HotelAgency")
  public void agencyHotel_DetailsPage(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, 
		...
		agencyHotel_SRP(driver, Hotel_Name,"DETAILSPAGEBOOK");
		agencyHotel_Itinerarypage(driver);
		agencyHotel_Travellerpage(driver);
		agencyHotel_Paymentpage(driver, Payment_Type, "", "Agency Coupon :", "Great, your booking went through successfully.");
    }
