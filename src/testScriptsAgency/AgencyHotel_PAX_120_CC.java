...
import domainServices.AgencyHotels;
	...
	public class AgencyHotel_PAX_120_CC extends AgencyHotels{
	public RemoteWebDriver driver;

	@DataProvider(name = "PaxPayment")
    public Object [ ][ ] Hotel_domestic() throws Exception {
      return new Object [ ] [ ] { { "Bangalore", "19", "21", "1", "2", "2", "3", "2", "0", "0", "0", "0", "", "CREDITCARD", 	"Agency Hotels MultiNights CC TripID : ", 		"We have confirmed your booking & emailed you all the details."}	    		  					 
      	};
  }
	
	 @Test(dataProvider = "PaxPayment", groups="Regression")
  public void agencyHotel_Pax120_CC_557(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, 
