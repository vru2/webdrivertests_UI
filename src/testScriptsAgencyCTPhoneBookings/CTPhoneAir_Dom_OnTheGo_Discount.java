...
import domainServices.Agency;
		...
		public class CTPhoneAir_Dom_OnTheGo_Discount extends Agency{
		public RemoteWebDriver driver;
		String TripID = null;
		
		@Test ( dataProviderClass = AgencyDataProvider.class,dataProvider="AirAgencyDom", groups="Regression")	  
		public void CTPhoneAir_OW_OntheGo_Discount_2200(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Pref_Airline, String Payment_Type,  String Trip_Logger_Msg, String Booking_Confirmation_Message) throws Exception {
		  ...
		  agencyAir_ItineraryPage_OntheGo_Discount(driver);
