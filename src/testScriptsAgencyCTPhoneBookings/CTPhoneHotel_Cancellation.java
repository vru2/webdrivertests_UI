...
import domainServices.AgencyHotels;
	...
	public class CTPhoneHotel_Cancellation extends AgencyHotels{
	public RemoteWebDriver driver;
	String TripID = null;
	
  @Test ( dataProviderClass = AgencyDataProvider.class,dataProvider="HotelAgency")
  public void CTPhoneBookingsHotelCancelation(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, 
		...
		TripID = agencyHotel_Paymentpage_NoSignOut(driver, Payment_Type, "", Logger_Msg, "Agency Hotels Special Rates Booking TripID : ");
