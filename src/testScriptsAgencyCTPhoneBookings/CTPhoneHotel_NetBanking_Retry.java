...
import domainServices.AgencyHotels;
	...
	public class CTPhoneHotel_NetBanking_Retry extends AgencyHotels{
	public RemoteWebDriver driver;

  @Test ( dataProviderClass = AgencyDataProvider.class,dataProvider="HotelAgency")
  public void CTPhoneBookingsHotel_NB_Retry(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, 
		...
		agencyHotel_Paymentpage(driver, "NETBANKING", "", Logger_Msg, Booking_Confirmation_Message);
		/*if(MakePaymentOnlyInQA2){
			agencyHotel_Paymentpage(driver, "DEPOSITACCOUNT", "", Logger_Msg, Booking_Confirmation_Message);
			}*/
		}
