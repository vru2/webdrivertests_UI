...
public class AirDom_OW_AmexWhiteLabel_Booking extends AirCommonMethod
{
	...
	public void airDom_OW_AmexWhiteLabel_Booking_36469(String[] origin, String[] destin,String flightPreference,String adults, String children, String infants,String Payment_Options, boolean insuranceRequired,String flight_type) throws Exception 
	{
		do
		{
