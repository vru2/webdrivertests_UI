...
public class AirDom_OW_AmexWhiteLabel_GDS_AirlinesCheck extends AirCommonMethod{
	...
	@Test(dataProvider = "AmexAirOWLCC")
...
driver.get(baseUrl);
		...
		driver.get(driver.getCurrentUrl()+"flights/results?from="+origin[attempt]+"&to="+destin[attempt]+"&depart_date="+onwarddate +"&adults=1&childs=0&infants=0&dep_time=0&class=Economy&airline="+airlines+"&carrier="+airlines);
	...
	@DataProvider(name = "AmexAirOWLCC")
	...
	return new Object[][] { 
				{ originSG, destinationSG, "Flights", "OneWay", "SG", "1", "0", "0",""},
				{ origin6E, destination6E, "Flights", "OneWay", "6E", "1", "0", "0","JetAirways"}
