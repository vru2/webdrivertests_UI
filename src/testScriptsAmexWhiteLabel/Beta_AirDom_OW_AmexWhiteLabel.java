...
public class Beta_AirDom_OW_AmexWhiteLabel extends AirCommonMethod{
	...
	public void startSelenium() throws Exception 
	{
		...
		//baseUrl = common.value("prod_Air_WhiteLabel_Amex_url");
	...
	public void airDom_OW_AmexWhiteLabel_Booking(String[] origin, String[] destin,String flightPreference,String adults, String children, String infants,String Payment_Options, boolean insuranceRequired,String flight_type) throws Exception 
	{
		do
		{
