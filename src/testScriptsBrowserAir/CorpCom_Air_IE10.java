...
public class CorpCom_Air_IE10 extends Corporate {
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "DEL", "BOM", "19", "20", "1", "0", "0", "","","DA" } };
	}

	@Test(dataProvider = "AirCorp")
	public void airCorpDomIE10(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
		...
		AirCorp_Paymentpage(driver, Payment_Type, "", "CorpAE Air IE10 : ");
	}
