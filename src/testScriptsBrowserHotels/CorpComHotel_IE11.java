...
import domainServices.Corporate;
	...
	public class CorpComHotel_IE11 extends Corporate{
	public RemoteWebDriver driver;

	@Test ( dataProviderClass = CorporateDataProvider.class,dataProvider="HotelCorp")
	public void CorpHotel_IE11(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
	  ...
	  corpHotel_PaymentPage(driver, Payment_Type, "" , Logger_Msg, "Corp Hotel IE11 Trip ID : ");
	}
