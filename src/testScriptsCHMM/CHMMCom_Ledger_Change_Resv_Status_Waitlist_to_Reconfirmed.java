...
import domainServices.CHMM;
	...
	public class CHMMCom_Ledger_Change_Resv_Status_Waitlist_to_Reconfirmed extends CHMM{
    ...
    public Object [ ][ ] CHMM_Hotel() throws Exception {
	 ...
	 public void LedgerChange_ReservationStatus_Reconfirmed_605() throws Exception {
	      driver.manage().deleteAllCookies();
		 driver.get(baseUrl);
		 CHMM_SignIN(driver, "");
		 CHMM_Ledger_Booking_DateSearch(driver, "1", "Wait List");
		 CHMM_Ledger_Status_Change(driver, "Reconfirmed", "Reconfirmed");
	 }
