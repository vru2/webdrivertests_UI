...
public class CHMMCom_RackRate_RR_RR_28 extends CHMM {
  ...
  public void CHMM_RackRate_RR_RR_GST28(String HotelName, String RoomType) throws Exception {
	  driver.manage().deleteAllCookies();
	  driver.get(baseUrl);
	  CHMM_SignIN(driver, "");
	  //CHMM_Add_Rate(driver, HotelName, RoomType, "Net");
	  CHMM_RackRate_AddRate(driver,HotelName,RoomType,"RRRR","Domestic",28);
  }
