...
import domainServices.CHMM;
	...
	public class CHMMCom_Search_Merchant_Email extends CHMM{
	public RemoteWebDriver driver;
	private String baseUrl;
	
	 @DataProvider(name = "CHMM_MerchantSearch")
	 public Object [ ][ ] Hotel_domestic() throws Exception {
	        return new Object [ ] [ ] { { "rg-connect@rategain.com"}};
	    }
	    
	@Test(dataProvider = "CHMM_MerchantSearch")
	public void CHMMSearch_Merchant_Email_593(String Merchant_Email) throws Exception {
      ...
      safeType(driver, getObject("CHMM_Merchants_Email"), Merchant_Email);
      ...
      textPresent(driver, Merchant_Email, 10);
  }
