...
public class AirCorp_Intl_OW_Hold_To_Confirm extends Corporate {
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "BOM", "SIN", "19", "20", "1", "0", "0", "","gds","" } };
	}

	@Test(dataProvider = "AirCorp")
	public void airCorpIntlAE_HoldToConfirm_487(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
		...
		if(MakePaymentOnlyInQA2){
		  AirCorp_Paymentpage(driver, Payment_Type, "", "CorpAE Intl OW Hold : ");
		  } 
	}
