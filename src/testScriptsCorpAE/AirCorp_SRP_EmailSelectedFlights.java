...
public class AirCorp_SRP_EmailSelectedFlights extends Corporate {
	...
	public static Object[][] AirCorpDomOW() {
		return new Object[][] { { "BOM", "MAA", "21", "22", "1", "0", "0", "","lcc" } };
	}
	
	
	@Test(dataProvider = "AirCorpDomOW")
	public void airCorpAEEmailSelectedFlight(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
	    ...
	    driver.findElement(By.id("fromName")).sendKeys("Automation");
	    driver.findElement(By.id("toEmail")).clear();
	    driver.findElement(By.id("toEmail")).sendKeys("deepa.kerur@cleartrip.com");
	    driver.findElement(By.id("message")).clear();
	    driver.findElement(By.id("message")).sendKeys("Automation Script");
