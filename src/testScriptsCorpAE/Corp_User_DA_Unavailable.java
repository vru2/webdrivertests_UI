...
import domainServices.Corporate;
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "Chennai", "Bangalore", "23", "24", "1", "1", "0", "","" } };
	}
	
	@Test (dataProvider = "AirCorp")
	public void deposit_Notdisplayed_HomePage_477(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
		...
		//AirCorp_Paymentpage(driver, "CC", "", "Corp Dom RT DA  unavaliable : ");
	}
