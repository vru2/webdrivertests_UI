...
public class AirCorp_Admin_AddDelete_Travellers extends Corporate {
    ...
    public void Corp_Adding_Traveller_258(String label, String fname, String lname, String emailID) throws Exception {

		driver.get(Corp_Plat_Url());
		corp_plat_SignIn(driver);
		textPresent(driver, "Fly anywhere. Fly everywhere.", 10);
		
		safeClick(driver, getObject("AirCorpCom_HomePage_Travellers_Tab"));
		waitElement(driver, getObject("AirCorpCom_Traveller_Add_Traveller_Button"), 10);
	    ...
	    textPresent(driver, "You should fill out", 20);   
	    assertTrue("Not able to add traveller", elementPresent_Time(driver, getObject("AirCorp_Traveller_EditPerson"), 10));
        Thread.sleep(2000);
     // }
    
  //  @Test(alwaysRun = true, dependsOnMethods = { "Corp_Adding_Traveller_258" },dataProvider = "traveller_details")
