...
public class AirCorp_DataValidation_OW_Dom_LCC extends Corporate {
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "BLR", "AMD", "19", "20", "1", "0", "0", "","lcc","DA" } };
	}

	@Test(dataProvider = "AirCorp")
	public void airCorpDom_dataValidationLCC_231(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
		...
		String TripID  = AirCorp_Paymentpage(driver, Payment_Type, "", "Corp Dom OW Data Validation LCC : ");
