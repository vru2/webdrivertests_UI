...
public class AirCorp_DataValidation_OW_Intl_GDS extends Corporate {
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "BOM", "DXB", "19", "20", "1", "0", "0", "","GDS","DA" } };
	}

	@Test(dataProvider = "AirCorp")
	public void airCorpDom_dataValidationGDS_232(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
		...
		String SRP_URL = corpCom_Air_SrpUrl(driver, FromCity, ToCity, Adults, Childrens, Infants, "IntlOW", Pref_Airline , 30, 31);
		driver.get(SRP_URL);
