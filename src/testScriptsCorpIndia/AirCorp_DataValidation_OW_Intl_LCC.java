...
public class AirCorp_DataValidation_OW_Intl_LCC extends Corporate {
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "CMB", "MAA", "19", "20", "1", "0", "0", "","LCC","DA" } };
	}

	@Test(dataProvider = "AirCorp")
	public void airCorpDom_dataValidationGDS_233(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
		...
		String SRP_URL = corpCom_Air_SrpUrl(driver, FromCity, ToCity, Adults, Childrens, Infants, "IntlOW", Pref_Airline , 40, 41);
		driver.get(SRP_URL);
		SRP_Data = corpCom_DataVal_Dom_SRP(driver, flight_type, SRP_Data);	 	
		corpAir_ItineraryPage(driver);
		TravellerPage_Data = corpCom_DataVal_TravellerPage_Intl(driver, Adults, Childrens, Infants, TravellerPage_Data);
		PaymentPage_Data = corpCom_DataVal_PaymentPage_Intl(driver, SRP_Data, TravellerPage_Data, PaymentPage_Data);
