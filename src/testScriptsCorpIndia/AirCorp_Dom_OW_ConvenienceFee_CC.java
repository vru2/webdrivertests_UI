...
public class AirCorp_Dom_OW_ConvenienceFee_CC extends Corporate {
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "DEL", "BOM", "1", "0", "0","CC" } };
	}

	@Test(dataProvider = "AirCorp")
	public void airCorpDom_ConvFee_218(String FromCity, String ToCity, String Adults, String Childrens, String Infants, String Payment_Type) throws Exception {
		...
		elementVisible(driver, By.id("processingFeeAmount"), 90, "Price is not displayed in PaymentPage");
