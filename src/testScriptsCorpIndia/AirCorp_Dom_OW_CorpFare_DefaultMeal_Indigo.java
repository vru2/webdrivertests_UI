...
public class AirCorp_Dom_OW_CorpFare_DefaultMeal_Indigo extends Corporate {
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "DEL", "BOM", "19", "20", "1", "0", "0", "6E" } };
	}

	@Test(dataProvider = "AirCorp")
	public void AirCorp_OW_CorpFareAddmealDefault_6E_238(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
		...
		String TripID = AirCorp_Paymentpage(driver, "", "", "Corp Dom OW CorpFare Indigo: ");	
		//validateXML(TripID, "<meal-status>", "</meal-status>", "SUCCESS");
		validateXML(TripID, "<meal-status", ">", "true");
		//validateXML("Q1702220816", "<meal-code>", "</meal-code>", "VGML");
