package testScriptsCorpIndia;
	...
	public class AirCorp_Dom_OW_With_GstAndState extends Corporate {
		...
		public void airCorpDom_withGstandState(String FromCity, String ToCity, String Adults, String Childrens, String Infants, String Payment_Type) throws Exception {
			...
			String TripID=AirCorp_Paymentpage(driver, Payment_Type, "", "Corp Dom OW PG fee : ");
