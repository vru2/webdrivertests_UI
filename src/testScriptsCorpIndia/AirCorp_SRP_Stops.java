...
public class AirCorp_SRP_Stops extends Corporate {
	...
	public static Object[][] AirCorp() {
		return new Object[][] { { "BLR", "GOA", "19", "20", "1", "0", "0", "","lcc","CC" } };
	}

	@Test(dataProvider = "AirCorp")
	public void Corp_SRP_Stops_247(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens,
		...
		if(!elementVisible(driver, By.xpath("//label[@for = '1_1_1']"), 5)) {
			Reporter.log("1 Stop Button is not displayed");
			Assert.assertTrue(false);
		} else {
			safeClick(driver, By.xpath("//label[@for = '1_1_0']"));
			//safeClick(driver, By.xpath("//label[@for = '1_1_1']"));
			mouseHover(driver, By.xpath("//tbody/tr/th[3]"));
			safeClick(driver, By.xpath("//a[contains(text(),'Flight itinerary')]"));
