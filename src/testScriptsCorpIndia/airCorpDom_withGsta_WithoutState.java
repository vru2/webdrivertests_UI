package testScriptsCorpIndia;
	...
	public class airCorpDom_withGsta_WithoutState extends Corporate {
		...
		public void airCorpDom_with_WithGstandWithoutState(String FromCity, String ToCity, String Adults, String Childrens, String Infants, String Payment_Type) throws Exception {
			...
			corpAir_TravellerPage(driver, Adults, Childrens, Infants,"true","false");
