package testScriptsCorpIndia;
	...
	public class airCorpDom_withoutGsta_WithState extends Corporate {
		...
		public void airCorpDom_with_WithoutGstandWithState(String FromCity, String ToCity, String Adults, String Childrens, String Infants, String Payment_Type) throws Exception {
			...
			corpAir_TravellerPage(driver, Adults, Childrens, Infants,"false","true");
