...
import domainServices.CorporateHotels;
	...
	public class HotelCorpAE_Coupon extends CorporateHotels{
	public RemoteWebDriver driver;

	@Test ( dataProviderClass = CorporateDataProvider.class,dataProvider="HotelCorp", groups = "Smoke Tests")
	public void CorpHotel_Coupon_583(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
	  ...
	  corpHotel_PaymentPage(driver, "CREDITCARD", "COUPONAE" , "Corp AE Coupon", Booking_Confirmation_Message);
	}
