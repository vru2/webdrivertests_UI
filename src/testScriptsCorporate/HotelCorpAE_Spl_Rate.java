...
import domainServices.CorporateHotels;
	...
	public class HotelCorpAE_Spl_Rate extends CorporateHotels{
	public RemoteWebDriver driver;

	@Test ( dataProviderClass = CorporateDataProvider.class,dataProvider="HotelCorp")
	public void CorpHotelAE_SplRate_581(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
			String Child1, String Child2, String ChildAge1, String ChildAge2, String Hotel_Name, String Payment_Type, String Logger_Msg, String Booking_Confirmation_Message) throws Exception {
	  driver.manage().deleteAllCookies();
	  corpAEHotel_SrpUrl(driver, "Mumbai", "Maharashtra", "IN", "1", 24, 25);
	  corpHotel_SRP(driver, Hotel_Name,"SPECIALRATECORP");
	  corpHotel_ItineraryPage(driver);
	  corpHotel_TravelerPage(driver);
	  String TripID= corpHotel_PaymentPage(driver, Payment_Type, "" , "CorpAE SPl rate Cancellation", Booking_Confirmation_Message);
		if(MakePaymentOnlyInQA2) {
			  ...
			  if(elementPresent_Time(driver, By.id("listView_a"), 5)){
				  ...
				  Thread.sleep(5000);
				  smartClick(driver, By.xpath("//td[2]/p/a"));
			  }
