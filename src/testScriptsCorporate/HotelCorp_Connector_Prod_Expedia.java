...
import domainServices.CorporateHotels;
	...
	public class HotelCorp_Connector_Prod_Expedia extends CorporateHotels{
	public RemoteWebDriver driver;

	@Test ( dataProviderClass = CorporateDataProvider.class,dataProvider="HotelCorp")
	public void CorpHotel_Exp_Connector_NB(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
		...
		String HotelB2B_Expedia = null;
		   if(ProductionUrl) {
			   ...
			   HotelB2B_Expedia =  dataFile.value("HotelB2B_Expedia");
		   }
		driver.get(Corp_Url());
	  corp_SignIn(driver);
	  ...
	  corpHotel_SRP(driver, HotelB2B_Expedia,"");
	  corpHotel_ItineraryPage(driver);
	  corpHotel_TravelerPage(driver);
	  corpHotel_PaymentPage(driver, "NETBANKINGCITI", "" , "Corp.com Expedia Connector NB  : ", Booking_Confirmation_Message);
	}
