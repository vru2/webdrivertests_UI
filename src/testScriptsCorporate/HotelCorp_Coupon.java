...
import domainServices.CorporateHotels;
	...
	public class HotelCorp_Coupon extends CorporateHotels{
	public RemoteWebDriver driver;

	@Test ( dataProviderClass = CorporateDataProvider.class,dataProvider="HotelCorp")
	public void CorpHotel_Coupon_571(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
	  ...
	  corpHotel_PaymentPage(driver, Payment_Type, "COUPON" , "Corp.com Coupon & Package Rate : ", Booking_Confirmation_Message);
	}
