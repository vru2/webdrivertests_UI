...
import domainServices.CorporateHotels;
	...
	public class HotelCorp_Intl extends CorporateHotels{	
	public RemoteWebDriver driver;

	@Test ( dataProviderClass = CorporateDataProvider.class,dataProvider="HotelCorpIntl")
	public void CorpHotelIntl_577(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
	  ...
	  corpHotel_Intl(driver, Hotel_Name,"");
	  ...
	  if(!elementVisible(driver, getObject("AgencyHotels_PaymentPage_Coupon_TextBox"), 50)) {
		Reporter.log("Corp Com Intl Hotels Payment page is not displayed");
		Assert.assertTrue(false);
	  }
	  corpHotel_PaymentPage(driver, "NBBOI", "" , "Corp com Intl NB Page : ", Booking_Confirmation_Message);
