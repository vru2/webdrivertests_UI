...
import domainServices.CorporateHotels;
	...
	public class HotelCorp_PAX_Payment_DC_131 extends CorporateHotels{
	public RemoteWebDriver driver;

	@DataProvider(name = "PaxPayment")
    public Object [ ][ ] Hotel_domestic() throws Exception {
      return new Object [ ] [ ] { { "bangalore", "19", "20", "1", "3", "2", "3", "2", "1", "1", "1", "0", "", "DEBITCARD", "Corp Hotels MultiPAX DC TripID : ", "Thanks for booking with Cleartrip" }	    		  					 
      	};
  }

	 @Test(dataProvider = "PaxPayment")
	public void CorpHotel_PAX_DC131_570(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
