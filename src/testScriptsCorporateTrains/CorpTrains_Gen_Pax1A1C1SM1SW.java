...
public class CorpTrains_Gen_Pax1A1C1SM1SW extends Trains{
	...
	@DataProvider
	  public static Object [ ][ ] CorpTrains_Gen_2A() {
	      return new Object [ ] [ ] { { "New Delhi","Chennai Central","Sleeper (SL)","10","General","Same","G T Express","1","1","1","1","CREDITCARD","B2C Trains HomePage SignIn General Booking with Adult=1","Your Booking is confirmed","Cancel"}};
	...
	public void CorpTrains_Gen_2A(String DStation, String AStaiton, String Class, String TDate,String Quota,String BoardStation,String TrainsName,String Adult1,String Child1,String SMen,String SWomen,String Payment_Type, 
		...
		Corp_IRCTC_LoginPage(driver,IRCTC_Action);
