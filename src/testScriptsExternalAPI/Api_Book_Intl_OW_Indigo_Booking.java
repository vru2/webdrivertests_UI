...
public class Api_Book_Intl_OW_Indigo_Booking extends APIServices{
	...
	@Test(groups = "Regression,smoke", dataProviderClass = APIDataProvider.class, dataProvider = "oneAdultIntlIndigo")
