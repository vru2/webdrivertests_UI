...
public class Api_Book_Intl_OW_SG_Booking extends APIServices{
	...
	@Test(groups = "Regression,smoke", dataProviderClass = APIDataProvider.class, dataProvider = "oneAdultIntlSGBooking")
	public void retailOneAdult_335(String from, String to, String carrier, String aCount, String cCount) throws Exception {
		...
		System.out.println("Api_Book_Intl_OW_SG_Booking");
		...
		do {
			String itinenaryResponseString=null;
...
//System.out.println(postString);
			HttpResponse itinenaryResponse = APIUtils.postApi(getBaseUrl() + "/air/1.0/itinerary/create", headers, postString,
					200);
			itinenaryResponseString = APIUtils.returnResponseAsString(itinenaryResponse);
			


				itineraryId = APIUtils.getNodeListFromXMLResponseString(itinenaryResponseString, "//itinerary/itinerary-id")
						.item(0).getTextContent();
				Reporter.log("Itinerary id="+itineraryId);
			} catch (Exception e) {
