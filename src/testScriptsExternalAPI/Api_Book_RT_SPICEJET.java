...
import java.util.Random;
	...
	public class Api_Book_RT_SPICEJET extends APIServices {
		...
		public void retailOneAdult_349(String from,String to,String carrier,String aCount,String cCount) throws Exception{
			...
			String url=getBaseUrl() + "/air/1.0/search?from=" + from + "&to=" + to + "&depart-date="
		...
		//System.out.println(s);
			...
			if(noOfFareKeys>0&&noOfFareKeys1>0)
			do {
	...
	//System.out.println(postString);
				...
				i++;
			} while ((i<(fareKeys1.size()-1))&&(i < (fareKeys.size()-1))&& flightUnavaliable&&i<5);  //test rajesh
			if ((common.value("makePayment").equals("true"))) { 
