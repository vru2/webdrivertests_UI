...
public class DomRTMultiPAX extends APIServices {
	...
	public void retailOneAdult_356(String from,String to,String carrier,String aCount,String cCount,String iCount) throws Exception{
...
System.out.println("return fare key="+key1);
			...
			String postString = post.replaceFirst("#Key",key).replaceFirst("#from",from).replaceFirst("#to", to)
					...
					.replaceFirst("#returndate", returndate).replaceAll("#Jivan","Jivan"+c).replaceAll("#Kotian","Kotian"+c).replaceAll("#Test","Test"+c);
System.out.println(postString);
		...
		System.out.println(common.value("protocol")+"://"+common.value("Environment")+".cleartrip.com/air/1.0/search?from="+from+"&to="+to+"&depart-date="+onwarddate+"&return-date="+returndate+"&adults="+aCount+"&children="+cCount+"&infants="+iCount+"&carrier="+carrier);
	    HttpGet get = new HttpGet(new URI(common.value("protocol")+"://"+common.value("Environment")+".cleartrip.com/air/1.0/search?from="+from+"&to="+to+"&depart-date="+onwarddate+"&return-date="+returndate+"&adults="+aCount+"&children="+cCount+"&infants="+iCount+"&carrier="+carrier));
		  ...
		  //System.out.println("response string="+responseString);
		      ...
		      // HttpEntity entity = response.getEntity();
				 StringBuffer sb13 = new StringBuffer();
					String str13="";
					BufferedReader br13 = new BufferedReader(new InputStreamReader(response.getEntity().getContent()));
					...
					JSONObject jsonObject1 = XML.toJSONObject(sb1.toString());
