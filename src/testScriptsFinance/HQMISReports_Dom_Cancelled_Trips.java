...
public class HQMISReports_Dom_Cancelled_Trips extends HQ

{
	...
	public void MISReport() throws Exception {
		...
		if (!driver.getCurrentUrl().equals("https://qa2.cleartrip.com/hq/reports/mis/air")) {
			...
			Select  drpairline = new Select(driver.findElement(By.id("airline")));
			drpairline.selectByVisibleText("IndiGo [6E]");
