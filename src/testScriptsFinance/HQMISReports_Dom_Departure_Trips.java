...
public class HQMISReports_Dom_Departure_Trips extends HQ

{
	...
	public void MISReport() throws Exception {
		...
		if (!driver.getCurrentUrl().equals("https://qa2.cleartrip.com/hq/reports/mis/air")) {
			...
			drpbooktype.selectByVisibleText("have a departure date");
			
			Select  drpB2B = new Select(driver.findElement(By.name("b2b_filter_type")));
			drpB2B.selectByVisibleText("Corporate Bookings");
