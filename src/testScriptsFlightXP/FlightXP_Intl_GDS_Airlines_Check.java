...
public class FlightXP_Intl_GDS_Airlines_Check extends AirCommonMethod{
	...
	@Test(dataProvider = "FlightXPAirOWGDS")
...
driver.get(baseUrl);
	...
	@DataProvider(name = "FlightXPAirOWGDS")
	public static Object[][] B2CAirOWLCCDomFullRefund() {
		...
		String originUK [] = {"DEL", "BLR", "DEL"};
		String destinationUK [] = {"DXB", "GOI", "BOM"};
		
				
	return new Object[][] { 
				{ originAI, destinationAI, "Flights", "OneWay", "AI", "1", "0", "0","AirIndia"},
				{ originUK, destinationUK, "Flights", "OneWay","EY", "1", "0", "0","Ethihad Airways"},
