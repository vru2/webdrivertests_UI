...
public class FlightXP_OW extends AirCommonMethod{
	...
	public void test_FlightXP_OW_36474(String[] origin, String[] destin,String flightPreference,String adults, String children,
		...
		ExpediaOnewaySearch(driver, origin[attempt], destin[attempt], "10", adults, children, infants,flightPreference);
		...
		elementVisible(driver, getObject("FlightXp_payment"), 300);
		...
		assertCommon(driver, "Great, your booking went through successfully.", 90, "Confirmation page not displayed");
