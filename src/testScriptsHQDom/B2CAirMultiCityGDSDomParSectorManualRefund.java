...
public class B2CAirMultiCityGDSDomParSectorManualRefund extends AirCommonMethod {
	...
	// public Object[][] B2CAirMultiCityGDSDomManualRefund() {
	// String origin [] = {"DEL", "BOM", "MAA"};
	// String destination [] = {"BOM", "MAA", "HYD"};
	// return new Object[][] { { 2, origin, destination, "1", "1", "1", "MULTICITY", "", "credit card", "gds", "ROUND",
	// "Manual Refund", false} };
	// }
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirMultiCityGDSDomManualRefund")
	public void airMultiCityGDSDomManualRefund(int numberOfSectors, String[] fromSet, String[] toSet, String adults,
			String children, String infants, String flight_mode, String flightPreference, String paymentMethod,
			String flight_type, String trip_type, String refundMethod, boolean insuranceRequired) throws Exception {
		...
		do {
			...
			for (WebElement sector : solutionSectors) {
				sector.click();
				warningFound = flightTypeFilter(flight_mode, driver, sectorNo);
				if (warningFound) {
					break;
				}
