...
public class B2CAirMultiCityGDSDomViaAutoRefund extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirMultiCityGDSDomViaAutoRefund") public Object[][] B2CAirMultiCityGDSDomViaAutoRefund() { String
	 * origin [] = {"DEL", "BOM", "MAA"}; String destination [] = {"BOM", "MAA", "HYD"}; return new Object[][] { { 2, origin,
	 * destination, "1", "1", "1", "MULTICITY", "", "credit card", "Via", "gds", "ROUND", "Auto Refund", false} }; }
	 */
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirMultiCityGDSDomViaAutoRefund")
	public void airMultiCityGDSDomViaAutoRefund(int numberOfSectors, String[] fromSet, String[] toSet, String adults,
		...
		do {
			...
			watch.stop();
			System.out.println("Time taken to signIn normally: " + watch.toString());
