...
public class B2CAirOWGDSDomViaAutoRefund extends AirCommonMethod {
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirOWGDSDomViaAutoRefund")
	public void airOWGDSDomViaAutoRefund(String[] fromSet, String[] toSet, String app, String tripType, String flightPreference,
		...
		do {
			...
			*/// assertionLinkedList = captureItineraryData(driver);
			...
			/*		if (paymentDone == true)
				...
				attempt++;
				Reporter.log("Re starting book process. Attempt number: " + attempt);
		...
		if (common.value("HQFlowFlag").equals("true") && common.value("makePayment").equals("true")) {
			...
			if (flagCancellation) {
				...
				hq.cancellationTripPartialPaxHQ(driver, "all");// full pax full segment cancellation
