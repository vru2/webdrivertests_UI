...
public class B2CAirOWGDSDomViaParSectorFullRefundAndAssert extends AirCommonMethod {
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirOWGDSDomViaParSectorFullRefundAndAssert")
	public void airOWGDSDomViaParSectorFullRefundAndAssert(String[] fromSet, String[] toSet, String app, String tripType,
		...
		if (common.value("HQFlowFlag").equals("true") && common.value("makePayment").equals("true")) {
			...
			if (flagCancellation && !(status.contains("Booking Failed")) && status != null) {
				...
				hq.cancellationTripPartialSectorHQ(driver, "partial via trip cancellation");// full pax partial via segment
																							// cancellation
