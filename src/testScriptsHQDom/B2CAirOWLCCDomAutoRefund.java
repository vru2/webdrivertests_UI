...
public class B2CAirOWLCCDomAutoRefund extends AirCommonMethod {
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirOWLCCDomAutoRefund")
	public void airOWLCCDomAutoRefund(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
