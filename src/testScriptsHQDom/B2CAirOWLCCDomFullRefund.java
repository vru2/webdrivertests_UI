...
public class B2CAirOWLCCDomFullRefund extends AirCommonMethod {
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirOWLCCDomFullRefund")
	public void airOWLCCDomFullRefund(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
