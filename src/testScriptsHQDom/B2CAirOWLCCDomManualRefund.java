...
/*
 * This scenarios deals with the problem statement as - One Way, Non - Direct ,
 * HQ Cancellation,Indigo flights , Full cancellation of PAX , Manual Cancellation
 */

//Indigo flights will not be available in qa2
...
public class B2CAirOWLCCDomManualRefund extends AirCommonMethod {
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirOWLCCDomManualRefund")
	public void airOWLCCDomManualRefund(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
