...
public class B2CAirRTGDSDomViaParPaxAutoRefund extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirRTGDSDomViaParPaxAutoRefund") public static Object[][] B2CAirRTGDSDomViaParPaxAutoRefund() {
	 * String[] origin = { "del", "bom", "blr" }; String[] destination = { "bom", "blr", "goa" }; return new Object[][] { {
	 * origin, destination, "Flights", "RoundTrip", "Air India", "Non Direct", "1", "1", "1", "credit card", "Via", false,
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirRTGDSDomViaParPaxAutoRefund")
	public void airRTGDSDomViaParPaxAutoRefund(String[] fromSet, String[] toSet, String app, String tripType,
		...
		if (common.value("HQFlowFlag").equals("true") && common.value("makePayment").equals("true")) {
			...
			if (flagCancellation && !(status.contains("Booking Failed")) && status != null) {
				...
				hq.cancellationTripPartialPaxHQ(driver, "partial");// partial pax full segment cancellation
