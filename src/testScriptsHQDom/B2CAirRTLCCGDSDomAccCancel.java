...
public class B2CAirRTLCCGDSDomAccCancel extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirRTLCCGDSDomAccCancel") public static Object[][] B2CAirRTLCCGDSDomAccCancel() { String[] origin
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirRTLCCGDSDomAccCancel")
	public void airRTLCCGDSDomAccCancel(String[] fromSet, String[] toSet, String app, String tripType, String flightPreference,
		...
		do {
			...
			for (WebElement returnFlight : returnFlights) {
				...
				if (returnFlight.findElement(By.xpath("./tr[2]/td/span")).getText().equalsIgnoreCase(returnSelectedFlightNo)) {
					...
					foundReturn = true;
					break;
				}// *[@id="flightForm"]/section[2]/div[4]/div[2]/nav/ul/li[1]/div/label/table/tbody/tr[1]/th[1]/input
			}
