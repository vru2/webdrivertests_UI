...
public class B2CAirRTLCCLCCDomAccCancel extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirRTLCCLCCDomAccCancel") public static Object[][] B2CAirRTLCCLCCDomAccCancel() { String[] origin
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirRTLCCLCCDomAccCancel")
	public void airRTLCCLCCDomAccCancel(String[] fromSet, String[] toSet, String app, String tripType, String flightPreference,
		...
		do {
			...
			warningFound = filterFlightsByPreferedAirlineReturn(driver, "Indigo", 0);
			if (warningFound) {
				attempt++;
				continue;
			}
