...
public class B2CAirMultiCityGDSDomViaParPaxAutoRefundAPI extends HQ {
	...
	public void airMultiCityGDSDomViaParPaxAutoRefundAPI_129() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirMultiCityGDSDomViaParPaxAutoRefundAPI", "email_id", "user_id");
