...
public class B2CAirMultiCityGDSDomViaParSectorAutoRefundAPI extends HQ {
	...
	public void airMultiCityGDSDomViaParSectorAutoRefundAPI_130() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirMultiCityGDSDomViaParSectorAutoRefundAPI", "email_id", "user_id");
