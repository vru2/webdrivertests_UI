...
public class B2CAirOWGDSDomViaAutoRefundAPI extends HQ {
	...
	@Test(groups="Smoke")
	public void airOWGDSDomViaAutoRefundAPI_132() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirOWGDSDomViaAutoRefundAPI", "email_id", "user_id");
		...
		if (flagCancellation) {
			...
			cancellationTripPartialPaxHQ(driver, "all");// full pax full segment cancellation
