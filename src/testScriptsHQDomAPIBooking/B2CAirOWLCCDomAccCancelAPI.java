...
public class B2CAirOWLCCDomAccCancelAPI extends AirCommonMethod {
	...
	public void airOWLCCDomAccCancelAPI_136() throws Exception {
		...
		tripId = hq.getAPITripId(domain, "B2CAirOWLCCDomAccCancelAPI", "email_id", "user_id");
