...
public class B2CAirOWLCCDomAutoRefundAPI extends HQ {
	...
	public void airOWLCCDomAutoRefundAPI_137() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirOWLCCDomAutoRefundAPI", "email_id", "user_id");
