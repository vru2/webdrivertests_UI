...
public class B2CAirOWLCCDomFullRefundAPI extends HQ {
	...
	public void airOWLCCDomFullRefundAPI_138() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirOWLCCDomFullRefundAPI", "email_id", "user_id");
