...
public class B2CAirOWLCCDomManualRefundAPI extends HQ {
	...
	public void airOWLCCDomManualRefundAPI_139() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirOWLCCDomManualRefundAPI", "email_id", "user_id");
