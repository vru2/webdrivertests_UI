...
public class B2CAirRTGDSLCCDomAccCancelAPI extends AirCommonMethod {
	...
	public void airRTGDSLCCDomAccCancelAPI_141() throws Exception {
		...
		tripId = hq.getAPITripId(domain, "B2CAirRTGDSLCCDomAccCancelAPI", "email_id", "user_id");
