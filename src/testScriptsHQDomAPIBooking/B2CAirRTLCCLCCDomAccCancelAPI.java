...
//trip ID expires on 
public class B2CAirRTLCCLCCDomAccCancelAPI extends AirCommonMethod {
	...
	public void airRTLCCLCCDomAccCancelAPI_143() throws Exception {
		...
		tripId = hq.getAPITripId(domain, "B2CAirRTLCCLCCDomAccCancelAPI", "email_id", "user_id");
