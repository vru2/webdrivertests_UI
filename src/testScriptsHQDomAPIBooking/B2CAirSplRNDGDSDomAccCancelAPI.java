...
public class B2CAirSplRNDGDSDomAccCancelAPI extends AirCommonMethod {
	...
	public void airSplRNDGDSDomAccCancelAPI() throws Exception {
		...
		tripId = hq.getAPITripId(domain, "B2CAirSplRNDGDSDomAccCancelAPI", "email_id", "user_id");
