...
public class B2CAirSplRNDLCCDomAccCancelAPI extends AirCommonMethod {
	...
	public void airSplRNDLCCDomAccCancel_144() throws Exception {
		...
		tripId = hq.getAPITripId(domain, "B2CAirSplRNDLCCDomAccCancelAPI", "email_id", "user_id");
