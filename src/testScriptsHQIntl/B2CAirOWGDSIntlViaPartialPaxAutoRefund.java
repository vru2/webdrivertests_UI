...
public class B2CAirOWGDSIntlViaPartialPaxAutoRefund extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirOWGDSIntlViaPartialPaxAutoRefund") public static Object[][]
	 * B2CAirOWGDSIntlViaPartialPaxAutoRefund() { String origin[] = { "DEL", "CMB", "BOM" }; String destination[] = { "DXB",
	 * "MAA", "DXB" }; return new Object[][] { { origin, destination, "Flights", "OneWay", "Air India", "Non Direct", "1", "1",
	 * "1", "credit card", "Via", false, "Auto Refund", false, "gds" } }; }
	 */
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirOWGDSIntlViaPartialPaxAutoRefund")
	public void airOWGDSIntlViaPartialPaxAutoRefund(String[] fromSet, String[] toSet, String app, String tripType,
