...
public class B2CAirOWLCCIntlManualRefund extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirOWLCCIntlManualRefund") public static Object[][] B2CAirOWLCCIntlManualRefund() { String
	 * origin[] = { "DEL", "CMB", "BOM" }; String destination[] = { "DXB", "MAA", "DXB" }; return new Object[][] { { origin,
	 * destination, "Flights", "OneWay", "lcc", "Direct", "1", "0", "0", "credit card", false, "Manual Refund" } }; }
	 */
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirOWLCCIntlManualRefund")
	public void airOWLCCIntlManualRefund(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
