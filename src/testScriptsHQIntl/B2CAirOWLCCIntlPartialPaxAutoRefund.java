...
public class B2CAirOWLCCIntlPartialPaxAutoRefund extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirOWLCCIntlPartialPaxAutoRefund") public static Object[][] B2CAirOWLCCIntlPartialPaxAutoRefund()
	 * { String origin[] = { "DEL", "CMB", "BOM" }; String destination[] = { "DXB", "MAA", "DXB" }; return new Object[][] { {
	 * origin, destination, "Flights", "OneWay", "lcc", "Direct", "1", "1", "1", "credit card", false, "Auto Refund" } }; }
	 */
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirOWLCCIntlPartialPaxAutoRefund")
	public void airOWLCCIntlPartialPaxAutoRefund(String[] fromSet, String[] toSet, String app, String tripType,
			String flight_type, String flightFilterType, String adults, String children, String infants, String paymentMethod,
