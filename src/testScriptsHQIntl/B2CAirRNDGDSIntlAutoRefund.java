...
public class B2CAirRNDGDSIntlAutoRefund extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirRNDGDSIntlAutoRefund") public static Object[][] B2CAirRNDGDSIntlAutoRefund() { String origin[]
	 * = { "DEL", "CMB", "BOM" }; String destination[] = { "DXB", "MAA", "DXB" }; return new Object[][] { { origin, destination,
	 * "Flights", "RoundTrip", "Air India", "Direct", "1", "1", "1", "credit card", false, "Auto Refund", false, "gds" } }; }
	 */
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirRNDGDSIntlAutoRefund")
	public void airRNDGDSIntlAutoRefund(String[] fromSet, String[] toSet, String app, String tripType, String flightPreference,
		...
		if (common.value("HQFlowFlag").equals("true") && common.value("makePayment").equals("true")) {
			...
			if (flagCancellation && !(status.contains("Booking Failed")) && status != null) {
				...
				hq.cancellationTripPartialPaxHQ(driver, "all");// full pax full sector cancellation
