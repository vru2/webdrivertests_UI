...
public class B2CAirRNDGDSIntlPartialPaxAutoRefund extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirRNDGDSIntlPartialPaxAutoRefund") public static Object[][]
	 * B2CAirRNDGDSIntlPartialPaxAutoRefund() { String origin[] = { "DEL", "CMB", "BOM" }; String destination[] = { "DXB", "MAA",
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirRNDGDSIntlPartialPaxAutoRefund")
	public void airRNDGDSIntlPartialPaxAutoRefund(String[] fromSet, String[] toSet, String app, String tripType,
