...
public class B2CAirRNDGDSIntlPartialSegAutoRefund extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirRNDGDSIntlPartialSegAutoRefund") public static Object[][]
	 * B2CAirRNDGDSIntlPartialSegAutoRefund() { String origin[] = { "DEL", "CMB", "BOM" }; String destination[] = { "DXB", "MAA",
	 * "DXB" }; return new Object[][] { { origin, destination, "Flights", "RoundTrip", "Air India", "Direct", "1", "1", "1",
	...
	@Test(groups="Regression",dataProviderClass = HQDataProvider.class, dataProvider = "B2CAirRNDGDSIntlPartialSegAutoRefund")
	public void airRNDGDSIntlPartialSegAutoRefund(String[] fromSet, String[] toSet, String app, String tripType,
		...
		if (common.value("HQFlowFlag").equals("true") && common.value("makePayment").equals("true")) {
			...
			if (flagCancellation && !(status.contains("Booking Failed")) && status != null) {
				...
				hq.cancellationTripPartialSectorHQ(driver, "partial round trip cancellation");// full pax partial round trip
																								// cancellation
				...
				if (cancelSuccess) {
					...
					if (cancelSuccess) {
						...
						if (flagCancellation) {
							hq.cancellationTripProcessStartHQ(driver);
							hq.cancellationTripPartialSectorHQ(driver, "partial round trip cancellation");
