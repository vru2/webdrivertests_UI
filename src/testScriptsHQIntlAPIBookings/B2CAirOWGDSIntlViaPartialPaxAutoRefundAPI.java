...
public class B2CAirOWGDSIntlViaPartialPaxAutoRefundAPI extends HQ {
	...
	public void airOWGDSIntlViaPartialPaxAutoRefundAPI_145() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirOWGDSIntlViaPartialPaxAutoRefundAPI", "email_id", "user_id");
