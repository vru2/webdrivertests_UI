...
public class B2CAirOWLCCIntlAutoRefundAPI extends HQ {
	...
	public void airOWLCCIntlAutoRefundAPI_146() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirOWLCCIntlAutoRefundAPI", "email_id", "user_id");
