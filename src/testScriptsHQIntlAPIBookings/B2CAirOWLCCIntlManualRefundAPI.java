...
public class B2CAirOWLCCIntlManualRefundAPI extends HQ {
	...
	public void airOWLCCIntlManualRefundAPI_147() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirOWLCCIntlManualRefundAPI", "email_id", "user_id");
