...
public class B2CAirOWLCCIntlPartialPaxAutoRefundAPI extends HQ {
	...
	public void airOWLCCIntlPartialPaxAutoRefundAPI_148() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirOWLCCIntlPartialPaxAutoRefundAPI", "email_id", "user_id");
