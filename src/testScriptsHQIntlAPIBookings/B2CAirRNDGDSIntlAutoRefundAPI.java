...
public class B2CAirRNDGDSIntlAutoRefundAPI extends HQ {
	...
	public void airRNDGDSIntlAutoRefundAPI_149() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirRNDGDSIntlAutoRefundAPI", "email_id", "user_id");
