...
public class B2CAirRNDGDSIntlPartialPaxAutoRefundAPI extends HQ {
	...
	public void airRNDGDSIntlPartialPaxAutoRefund_150() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirRNDGDSIntlPartialPaxAutoRefundAPI", "email_id", "user_id");
