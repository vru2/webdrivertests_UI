...
public class B2CAirRNDGDSIntlStopOverAutoRefundAPI extends HQ {
	...
	public void airRNDGDSIntlStopOverAutoRefund() throws Exception {
		...
		tripId = getAPITripId(domain, "B2CAirRNDGDSIntlStopOverAutoRefundAPI", "email_id", "user_id");
