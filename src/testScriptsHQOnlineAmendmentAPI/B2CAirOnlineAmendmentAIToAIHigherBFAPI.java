...
public class B2CAirOnlineAmendmentAIToAIHigherBFAPI extends HQ {
	...
	public void airOnlineAmendmentAIToAIHigherBFAPI_110() throws Exception {

		Reporter.log("Test case " + this.getClass() + " started");
		System.out.println("Test case " + this.getClass() + " started");

		tripId = getAPITripId(domain, "B2CAirOnlineAmendmentAIToAIHigherBFAPI", "email_id", "user_id");
		...
		if (flagAmendment) {
			...
			onlineAmendmentSRPHQOWHighBF(driver, "Air India", bf);
