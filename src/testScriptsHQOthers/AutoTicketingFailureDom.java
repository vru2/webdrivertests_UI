...
public class AutoTicketingFailureDom extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "B2CAirOWGDSDomTicketingFailure") public static Object[][] B2CAirOWGDSDomTicketingFailure() { String[]
	 * origin = { "bom" }; String[] destination = { "goa" }; return new Object[][] { { origin, destination, "Flights", "OneWay",
	 * "Air India", "Direct", "1", "0", "0", "credit card", false, "Auto Refund" } }; }
	 */
