...
public class CouponConversionDomRNDCheck extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "CouponConversionDomRNDCheck") public static Object[][] CouponConversionReject() { String[] origin = {
	 * "del", "hyd" }; String[] destination = { "amd", "maa" }; return new Object[][] { { origin, destination, "Flights",
	 * "RoundTrip", "lcc", "SpiceJet", "Direct", "1", "0", "0", "credit card", false } }; }
	 */
	...
	@Test(groups = "Regression", dataProviderClass = HQDataProvider.class, dataProvider = "CouponConversionDomRNDCheck")
	public void couponConversionDomRNDCheck_122(String[] fromSet, String[] toSet, String app, String tripType,
