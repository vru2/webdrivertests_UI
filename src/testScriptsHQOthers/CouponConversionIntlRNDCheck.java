...
public class CouponConversionIntlRNDCheck extends AirCommonMethod {
	...
	/*
	 * @DataProvider(name = "CouponConversionIntlRNDCheck") public static Object[][] CouponConversionIntlRNDCheck() { String[]
	 * origin = { "maa", "cmb" }; String[] destination = { "cmb", "maa" }; return new Object[][] { { origin, destination,
	 * "Flights", "RoundTrip", "", "Air India", "Direct", "1", "0", "0", "credit card", false } }; }
	 */
	...
	@Test(groups = "Regression", dataProviderClass = HQDataProvider.class, dataProvider = "CouponConversionIntlRNDCheck")
	public void couponConversionIntlRNDCheck_123(String[] fromSet, String[] toSet, String app, String tripType,
