...
public class CouponConversionXMLStatusCheckConvert extends AirCommonMethod {
	...
	public void couponConversionConvert(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
		...
		if (common.value("HQFlowFlag").equals("true") && common.value("makePayment").equals("true")) {
			...
			failure = checkBookingStatusTripXML(tripId, "C");
