...
public class SyncTabCheckAPI extends HQ {
	...
	//expiry date of TripID is 10/06/2018
	@Test(groups="Regression")
	public void syncTabCheckAPI() throws Exception {

		Reporter.log("Test case " + this.getClass() + " started");
		System.out.println("Test case " + this.getClass() + " started");

		tripId = getAPITripId(domain, "SyncTabCheckAPI", "email_id", "user_id");
