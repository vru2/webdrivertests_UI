...
public class HQRewardReport extends HQ {
	...
	public void rewardReportSanity_117() throws Exception {
		...
		elementVisible(driver, getObject("Reward_Program_Report_Type"), 30);
		...
		for (int i = 5; i <= 6; i++) {
			/*assertTrue("Download link absent. Error!",
					driver.findElement(By.xpath("//*[@id='ContentFrame']/table/tbody/tr[" + i + "]/td[3]/a")).getText()
							.equals("Download"));*/
			String DownloadStatus = getText(driver, By.xpath("//*[@id='ContentFrame']/table/tbody/tr[\" + i + \"]/td[3]/a"));
			if(!DownloadStatus.contains("Download")) {
				Reporter.log("Download text is not displayed");
