...
import domainServices.AirCommonMethod;
	...
	public class AirComUnsignedUserBooking extends AirCommonMethod{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test ( dataProviderClass = IndiaDataProvider.class,dataProvider="AirCom_Dom_OW_LCC")
  public void AirComUnSigned(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants,String bookclass, String pref_airline, String Trip_Logger_Msg) throws Exception {
	  driver.get(baseUrl);
  ...
  public Object [ ][ ] AirCom() {
      return new Object [ ] [ ] { { "Bangalore", "New Delhi", "19", "20", "1", "0", "0", "AirCom Unsigned User Oneway TripID : "}};
  }
