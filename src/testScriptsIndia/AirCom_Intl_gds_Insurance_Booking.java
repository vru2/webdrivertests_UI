...
public class AirCom_Intl_gds_Insurance_Booking extends AirCommonMethod { 
	...
	public void airCom_Intl_gds_Insurance_Booking_209(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
	...
	do {
			...
			waitForElement(driver,30,getObject("AirCom_BookStep4_MakePayment_Button"));
	...
	public static Object[][] B2CAirOWLCCDomFullRefund() {
		String[] origin = {"del","del","bom"};
		String[] destination = {"dxb","cmb","dxb","dxb"};
