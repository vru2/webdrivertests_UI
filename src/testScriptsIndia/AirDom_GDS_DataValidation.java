...
public class AirDom_GDS_DataValidation extends AirCommonMethod{
		...
		public void Dom_LCC_Airline(String[] origin, String[] destin, String app, String tripType, String flight_type,
			...
			int attempt = 0;
			String Firstname="yvonnnne";
			String Lastname="kotiann";
			...
			//do {
				...
				airCom_HomepageSearch_Oneway(driver, origin[attempt], destin[attempt], "10", adults, children, infants,common.value("gdsairline"),attempt);
			...
			Thread.sleep(1000);
				...
				insuranceBlock(driver, insuranceRequired);
					...
					//System.out.println("confirmation total="+driver.findElement(By.xpath("//ul[@class='clearFix']/li[2]")).getText());
					//driver.close();
				...
				System.out.println("completed");*/
					...
					//HttpGet get = new HttpGet(new URI("http://10.10.21.107:9080/trips/Q1611080064"));
					...
					String bookDetails=sb.toString();
					 String [ ] getbookingStatus = bookDetails.split("<booking-status>");
		               ...
		               // System.out.println("TLastname= " + TLastname[0]);
		                ...
		                //System.out.println("TFare= " + Tfare[0]);
		...
		public static Object[][] B2CAirOWLCCDomFullRefund() {
			...
			return new Object[][] { { origin, destination, "Flights", "OneWay", "gds", "", "Direct", "1", "0", "0",
