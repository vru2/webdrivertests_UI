...
public class AirDom_LCC_DataValidation extends AirCommonMethod {
		...
		do {
				...
				insuranceBlock(driver, insuranceRequired);
					...
					HttpGet get = new HttpGet(new URI("http://10.10.21.187:9080/trips/"+getText(driver, getObject("AirCom_Confirmation_TripID"))));
					 ...
					 String [ ] getbookingStatus = bookDetails.split("<booking-status>");
		               ...
		               // System.out.println("ticket-number= " + ticketNumber[0]);
		                Reporter.log("ticket-number= " + ticketNumber[0]);
		                	...
		                	Assert.assertEquals(bookingStatus[0],"P","Booking status failed");
		                }
		              ...
		              //  System.out.println("total-fare= " + TotalFare[0]);
		               ...
		               // System.out.println("TFare= " + Tfare[0]);
		                ...
		                //System.out.println("Airways="+Flightname+"  flightnumber="+Flightnumber+" departure airport="+Departure+" arrival airport="+Arrival+"  date="+date);
