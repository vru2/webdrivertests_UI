...
public class AirDom_OW_FexiSearch_SystemDateBooking extends AirCommonMethod
{		
	...
	public void airDom_OW_FexiSearch_SystemDateBooking_Test(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
			...
			String paymentMethod, boolean insuranceRequired, String refundMethod) throws Exception 
	{
		...
		do 
		{
			...
			selectFexiSearchSystemDate_OW(driver);
