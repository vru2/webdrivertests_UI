...
public class AirDom_OW_IndiGo_AddMeal_Booking extends AirCommonMethod { 
	...
	public void Air_OW_Indigo_AddMeal_Booking_97(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
		...
		do {
			...
			boolean failAfterBookButton = waitForElement(driver,90,getObject("AirCom_SRP_Oneway_BookButton"));
