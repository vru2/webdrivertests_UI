...
public class AirDom_OW_Indigo_WebCheckIn_ExpressFlow extends AirCommonMethod 
{ 
	...
	public static Object[][] B2CAirOWLCCDomFullRefund() {
		...
		return new Object[][] { { origin, destination, "Flights", "OneWay","lcc", "IndiGo", "Direct", "1", "0", "0", "credit card", false,"Full Refund" } };
	}

	@Test(dataProvider = "B2CAirOWLCC")
	public void OW_Indigo_WebCheckIn_ExpressFlow(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
