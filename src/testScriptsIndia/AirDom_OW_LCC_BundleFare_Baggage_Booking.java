package testScriptsIndia;
	...
	public class AirDom_OW_LCC_BundleFare_Baggage_Booking extends AirCommonMethod { 
		...
		public void AirDom_BundleFare_Baggage_Booking(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
			...
			do {
				...
				SelectBundleFareAddOn(driver,"","baggage","","");
			...
			assertTrue("Baggage Txt Not Present on Confirmation page", textPresent(driver, "Baggage", 1));
