package testScriptsIndia;
	...
	*/
	...
	public class AirDom_OW_LCC_BundleFare_Meals_Booking extends AirCommonMethod { 
		...
		public void AirDom_BundleFare_Meals_Booking(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
			...
			do {
				...
				SelectBundleFareAddOn(driver,"","","meals","");
			...
			assertTrue("Meals Txt Not Present on Confirmation page", textPresent(driver, "Meal", 1));
