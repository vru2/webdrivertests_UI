...
import domainServices.AirCommonMethod;
	...
	public class AirDom_OW_LCC_BundleFare_SeatSelection_Booking extends AirCommonMethod { 
		...
		public void AirDom_BundleFare_SeatSel_Booking(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
			...
			do {
				...
				SelectBundleFareAddOn(driver,"","","","seat");
		...
		public static Object[][] B2CAirOWLCC() {
			String[] origin = { "blr","maa","del"};
			String[] destination = {"maa","blr","bom"};
