...
public class AirDom_OW_SameDay_Search_Results extends AirCommonMethod {
	...
	public void Air_Dom_OW_SameDay_Search_85(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
		...
		do {
			...
			Reporter.log("Same Day Search Results For DOM OW Flights Are Displayed",true);
