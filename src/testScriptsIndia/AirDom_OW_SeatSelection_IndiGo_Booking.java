...
public class AirDom_OW_SeatSelection_IndiGo_Booking extends AirCommonMethod { 
	...
	public static Object[][] B2CAirOWLCC() {
		String[] origin = { "maa","ccu","del"};
		String[] destination = {"blr","hyd","bom"};
		return new Object[][] { { origin, destination, "Flights", "OneWay", "lcc", "IndiGo", "", "1", "0", "0",
				"credit card", false} };
	}

	@Test(dataProvider = "B2CAirOWLCC")
	public void AirDom_OW_SeatSelection_IndiGo_booking_101(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
