...
public class AirDom_OW_StopOver_GDS_Flight_Booking extends AirCommonMethod {
//only on sundays stop over will come from goa to delhi(for vistara)
	...
	public static Object[][] B2CAirOW() {
		String[] origin = { "del","Goi", "bom", "blr" };
		String[] destination = { "bom","Del", "del", "bom" };
		return new Object[][] { { origin, destination, "Flights", "OneWay", "Vistara", "", "1", "0", "0",
				"credit card", "stopover", false, false, "" } };
	}

	@Test(dataProvider = "DomOW")
	public void airDom_OW_StopOver_GDS_Flight_Booking_178(String[] fromSet, String[] toSet, String app, String tripType,
		...
		do {
			...
			airCom_HomepageSearch_Oneway(driver, fromSet[attempt], toSet[attempt], "8", adults, children, infants,
		...
		//warningFound = selectingStop(flightFilterType, driver,1);
			...
			selectingStopOver(driver);
			 //selectingStop("Non Direct", driver,1);
			
				
			//customAirline(driver,"Air India",0);
