...
public class Air_Ow_Dom_Multipax_Zoom_Air {

	
	TestCase Description: Add a meal to indigo booking with 1 pax 
	*/

	public class AirDom_OW_ZoomAir_Multipax_booking extends AirCommonMethod { 
...
//				String paymentMethod, boolean insuranceRequired) throws Exception {
			public void airCom_Dom_ZoomAir(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
					String flightPreference, String flightFilterType, String adults, String children, String infants,
					String paymentMethod,boolean InsuranceRequired) throws Exception {
...
//				
			...
			System.out.println("check");
				...
				assertTrue("Insurance Not Added", textPresent(driver, "Insurance", 1));
		...
		//done changes here
		public static Object[][] B2CAirOWZOOMAir() {
			String[] origin = { "DEl","DEL"};
			String[] destination = {"IXC","RDP"};
			return new Object[][] { { origin, destination, "Flights", "OneWay", "lcc", "Zoom Air", "Zoom Air", "1", "1", "1",
					"credit card" ,false} };
		}
