...
public class AirDom_RT_Effective_Price_Check extends AirCommonMethod
{		
	...
	public void airDom_RT_RT_Effective_Price_Check_36455(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
			...
			String paymentMethod, String flightSegments, boolean insuranceRequired, String refundMethod) throws Exception 
	{
		...
		do 
		{
			...
			moneyToPratialWallet("PROMOTION", "CREDIT", "300");
			...
			if (!flightCountFailure) 
			{
				...
				attempt++;
				moneyToPratialWallet("REDEEM", "DEBIT", "300");
				continue;
			}
