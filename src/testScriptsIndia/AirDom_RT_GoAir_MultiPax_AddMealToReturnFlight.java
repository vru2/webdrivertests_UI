...
/*
Test Case Description:	Add Meals to DOM RT GoAir flight with multi pax,add meals to only to one pax. 
*/

public class AirDom_RT_GoAir_MultiPax_AddMealToReturnFlight extends AirCommonMethod {
	...
	public static Object[][] B2CAirRTGDSDomViaParPaxAutoRefund() {
		String[] origin = { "bom","blr","blr"};
		String[] destination = {"del","maa","goi"};
		return new Object[][] { { origin, destination, "Flights", "RoundTrip", "GoAir", "Non Direct", "1", "1", "0",
