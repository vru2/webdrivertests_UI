...
public class AirDom_RT_IndiGo_AddBaggage_Booking extends AirCommonMethod {
...
int x=0;
		...
		public void Air_RT_IndiGo_Baggage_Booking_192(String[] fromSet, String[] toSet, String app, String tripType,
...
//				Thread.sleep(3000);
				...
				Reporter.log("Onward Baggage Added");
