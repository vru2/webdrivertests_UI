...
public class AirDom_RT_OnwardSeatSelection_IndiGo_Booking extends AirCommonMethod {
	...
	public static Object[][] B2CAirRT() {
		String[] origin = {"del", "bom",};//,"blr","del"
		String[] destination = {"bom","del"};//,"maa","bom"
	...
	public void AirDomRT_OnwardSeatSelection_IndiGo_Booking(String[] fromSet, String[] toSet, String app, String tripType,
