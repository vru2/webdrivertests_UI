...
public class AirDom_RT_SG_OnwardWithBaggae_ReturnWithoutBaggage_Booking extends AirCommonMethod {
	...
	public void Air_RT_SG_OnwardWithBaggae_ReturnWithoutBaggage(String[] fromSet, String[] toSet, String app, String tripType,
		...
		do {
			...
			/*boolean baggageFound = SelectAddBaggageFlightOnwardWithBGReturnWithoutBG(driver,"OnwardWithBG","ReturnWithoutBG");
			if (!baggageFound) {
				attempt++;
