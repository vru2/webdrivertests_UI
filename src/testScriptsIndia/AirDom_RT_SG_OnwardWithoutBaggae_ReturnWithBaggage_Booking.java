...
/*
Test Case Description:	From RT SRP select onward flight without baggage and round trip flight with baggage and in the book step add baggage for return flight and do booking 
*/


public class AirDom_RT_SG_OnwardWithoutBaggae_ReturnWithBaggage_Booking extends AirCommonMethod {
	...
	public void Air_RT_SG_OnwardWithoutBaggae_ReturnWithBaggage(String[] fromSet, String[] toSet, String app, String tripType,
		...
		do {
			...
			/*boolean baggageFound = SelectAddBaggageFlightOnwardWithBGReturnWithoutBG(driver,"OnwardWithoutBG","ReturnWithBG");
			if (!baggageFound) {
				attempt++;
