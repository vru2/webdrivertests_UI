...
public class AirDom_RT_SG_OnwardandReturn_WithoutBaggage_WithMultiPax_Booking extends AirCommonMethod {
	...
	public static Object[][] B2CAirRTGDSDomViaParPaxAutoRefund() {
		...
		return new Object[][] { { origin, destination, "Flights", "RoundTrip", "SpiceJet", "", "1", "1", "1",
...
public void Air_RT_SG_OnwardandReturn_WithoutBaggage_WithMultiPax_AddBaggageToReturnFlight(String[] fromSet, String[] toSet, String app, String tripType,
	...
	smartClick(driver, getObject("AirCom_BookStep_AddBaggageBtn"));
		...
		//Only add baggage to Return flight
		...
		elementPresent_Time(driver, By.xpath("//div[@id='afterBaggae']/div/div[2]/button"), 10);
