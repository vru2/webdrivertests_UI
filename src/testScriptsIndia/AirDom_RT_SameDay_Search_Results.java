...
public class AirDom_RT_SameDay_Search_Results extends AirCommonMethod {
	...
	public void Air_Dom_RT_SameDay_Search_86(String[] fromSet, String[] toSet, String app, String tripType,
		...
		do {
			...
			airCom_HomepageSearch_RoundTrip(driver, fromSet[attempt], toSet[attempt], "10", "10", adults, children, infants,
			...
			Reporter.log("Same Day Search Results For DOM RT Flights Are Displayed");
			//System.out.println("Same Day Search Results For DOM RT Flights Are Displayed");
