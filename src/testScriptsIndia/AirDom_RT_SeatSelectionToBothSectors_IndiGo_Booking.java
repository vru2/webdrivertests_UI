...
public class AirDom_RT_SeatSelectionToBothSectors_IndiGo_Booking extends AirCommonMethod {
	...
	public static Object[][] B2CAirRT() {
		String[] origin = { "ccu","ccu","del"};
		String[] destination = {"bom","hyd","bom"};
		return new Object[][] { { origin, destination, "Flights", "RoundTrip", "IndiGo", "Non Direct", "1", "0", "0",
	...
	public void AirDom_RT_SeatSlection_6E_Booking_104(String[] fromSet, String[] toSet, String app, String tripType,
		...
		do {
			...
			selectingStop(flightFilterType,driver,0);
