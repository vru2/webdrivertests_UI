...
public class AirDom_RT_SeatSelectionToBothSectors_SG_Booking extends AirCommonMethod {
	...
	public static Object[][] B2CAirRTGDSDomViaParPaxAutoRefund() {
		...
		return new Object[][] { { origin, destination, "Flights", "RoundTrip", "SpiceJet", "", "1", "0", "0",
				"credit card", "", false, false, "lcc" } };
	}
	

	
	@Test(dataProvider= "B2CAirRT")
	public void AirDom_RT_SeatSlection_SG_Booking_103(String[] fromSet, String[] toSet, String app, String tripType,
