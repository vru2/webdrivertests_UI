...
public class AirDom_SPRT_Beta_and_Prod_Validation extends AirCommonMethod {
...
HashMap<String,String> hp=new HashMap<String,String>();
		...
		do {
			...
			for(int j1=1;j1<we2.size();j1++){
				...
				Assert.assertEquals(hp.get("prodtabhighlightedamount"+j1),hp.get("betatabhighlightedamount"+j1));
				Assert.assertEquals(hp.get("prodOnwardFlightNumber"+j1),hp.get("betaOnwardFlightNumber"+j1));
				Assert.assertEquals(hp.get("prodReturnFlightNumber"+j1),hp.get("betaReturnFlightNumber"+j1));
