 ...
 * EBL-6676: Test case to verify Air India Express connector for OW booking
 * Test Rail ref: C27267
 */

public class AirIntl_AIE_Connector_OW_MPax_Booking extends AirCommonMethod {
	...
	public static Object[][] B2CAirAIE_Connector() {
		...
		return new Object[][] { { origin, destination, "Flights", "OneWay",
				"lcc", "Air India Express", "", "1", "1", "1", "credit card",
				false } };
	}

	@Test(dataProvider = "B2CAirOWLCC")
	public void airIntl_AIE_Connector_OW_MPax_Booking_(String[] fromSet,
