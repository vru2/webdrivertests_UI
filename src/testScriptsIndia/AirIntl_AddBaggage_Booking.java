...
public class AirIntl_AddBaggage_Booking extends AirCommonMethod {
	...
	public void airIntl_AddBaggage_Booking_213(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
		...
		do {
			...
			if(elementPresent(driver,By.id("close"),7)){
	...
	public static Object[][] B2CAirOWLCCDomFullRefund() {
		String[] origin = {"MAA","Maa","maa","blr"};
		String[] destination = {"CMB","cmb","blr","pnq"};
