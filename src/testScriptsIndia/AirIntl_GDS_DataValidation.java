...
public class AirIntl_GDS_DataValidation extends AirCommonMethod{
		...
		public void Dom_LCC_Airline(String[] origin, String[] destin, String app, String tripType, String flight_type,
			...
			Thread.sleep(1000);
				...
				System.out.println("completed");*/
					...
					Reporter.log("http://10.10.21.107:9080/trips/"+getText(driver, getObject("AirCom_Confirmation_TripID")));
		...
		public static Object[][] B2CAirOWLCCDomFullRefund() {
			...
			String[] destination = {"CMB","DXB","lon"};
