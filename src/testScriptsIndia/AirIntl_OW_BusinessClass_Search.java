...
import domainServices.AirCommonMethod;
	...
	public class AirIntl_OW_BusinessClass_Search extends AirCommonMethod { 
		...
		public void Intl_OW_BusinessClassSearch_197(String[] origin, String[] destin, String app, String tripType, String flight_type,
			...
			do {
				...
				if (elementPresent(driver, getObject("AirCom_SRP_FlightsCount"),10)){
					Reporter.log("Results avaiable",true);
				}else {
					refreshPage(driver);
					elementPresent(driver, getObject("AirCom_SRP_FlightsCount"),10);
				}
