...
public class AirIntl_TigerAirways_NB_Retry extends AirCommonMethod{
...
//
	...
	public static Object[][] B2CAirOWLCCDomFullRefund() {
		String[] origin = {"kualal"};
		String[] destination = {"sin"};
		return new Object[][] { { origin, destination, "Flights", "OneWay", "lcc", "Tiger Airways", "", "1", "0", "0",
				"credit card", false} };
	}
