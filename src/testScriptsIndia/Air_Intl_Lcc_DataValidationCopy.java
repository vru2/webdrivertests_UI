...
public class Air_Intl_Lcc_DataValidationCopy extends AirCommonMethod{
	...
	public void Dom_LCC_Airline(String[] origin, String[] destin, String app, String tripType, String flight_type,
		...
		String SRP_URL = air_SrpUrl(driver, "com", origin1, destin1, adults, children, infants, "IntlOW", "", 10, 20);
