...
import domainServices.IndiaHotels;
	...
	public class HotelCom_Payment_Pax_Wallet_1R_2A_1C extends IndiaHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

	 @DataProvider(name = "PaxPayment")
	 public Object [ ][ ] Hotel_domestic() throws Exception {
	      return new Object [ ] [ ] { { "Mumbai", "15", "16", "1", "2", "1", "1", "1", "1", "0", "1", "1", "", "WALLET",     "Hotel Wallet Payment TripID : ", "Your booking is done"}	    		  					 
	      	};
	  }

	 @Test(dataProvider = "PaxPayment")
	 public void HotelComWallet_221_521(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
