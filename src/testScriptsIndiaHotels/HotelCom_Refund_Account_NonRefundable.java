...
public class HotelCom_Refund_Account_NonRefundable extends IndiaHotels{
	...
	public void HotelCom_Refund_Acct_FC() throws Exception {
		...
		hotelCom_DetailsPage(driver, "com", dataFile.value("HotelID_NonRefundable"), 30, ""); 
		...
		hotelCom_Refund_Cases(driver, TripID, "NR");
	  }
