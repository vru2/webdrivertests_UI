...
import domainServices.IndiaHotels;
	...
	public class HotelCom_SRP_SearchTags extends IndiaHotels{
  ...
  public void SRP_SearchTags() throws Exception {
	  ...
	  String Search_Hotel_Tag1 = getText(driver, getObjectHotels("HotelCom_SRP_SearchTag1_Hotel") );
	  String Search_Hotel_Tag2 = getText(driver, getObjectHotels("HotelCom_SRP_SearchTag2_Hotel") );
	  ...
	  Thread.sleep(2000);
	  if(!elementVisible(driver, getObjectHotels("HotelCom_SRP_SearchTag1_Hotel"), 2)) {
