...
import domainServices.IndiaHotels;
	...
	public class HotelCom_Search_Travellers_Option_1Room_2Adults_DC extends IndiaHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

	@DataProvider(name = "TravellerOption")
    public Object [ ][ ] Hotel_domestic() throws Exception {
      return new Object [ ] [ ] {  {  "Mumbai", "20", "21", "1 room, 2 adults", "", "", "", "", "0", "0", "0", "0", "", "CREDITCARD", "Hotels Traveller Option 1 room 2 adults Booking", "Your booking is done"}	    		  					 
      	};
 	 }

	@Test(dataProvider = "TravellerOption")
	public void Traveller_Option_Search12_519(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, String Adult3, String Adult4, 
