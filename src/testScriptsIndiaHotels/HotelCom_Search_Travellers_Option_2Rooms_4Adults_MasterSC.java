...
import domainServices.IndiaHotels;
	...
	public class HotelCom_Search_Travellers_Option_2Rooms_4Adults_MasterSC extends IndiaHotels{
	public RemoteWebDriver driver;
	private String baseUrl;
	
		@DataProvider(name = "TravellerOption")
	    public Object [ ][ ] Hotel_domestic() throws Exception {
	      return new Object [ ] [ ] {  {  "New delhi", "23", "24", "2 rooms, 4 adults", "", "", "", "", "0", "0", "0", "0", "", "MASTERSTOREDCARD", "Hotels Traveller Option 2 room 4 adults Booking", "Your booking is done"}	    		  					 
	      	};
	 	 }
