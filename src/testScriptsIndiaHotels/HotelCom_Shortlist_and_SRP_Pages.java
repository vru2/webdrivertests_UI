...
import domainServices.IndiaHotels;
	...
	public class HotelCom_Shortlist_and_SRP_Pages extends IndiaHotels{
  ...
  public void HotelCom_ShortlistPage() throws Exception {	   
	   //Verifing Shortlist link in SRP	   
		...
		/*String HotelName_Shortlist = getText(driver, getObjectHotels("HotelCom_ShortlistPage_HotelName"));
		if(!HotelName_Shortlist.equalsIgnoreCase(HotelName_SRP)) {
			System.out.println(HotelName_Shortlist);
			Reporter.log("Hotel added is not displayed");
			Assert.assertTrue(false);
		}
		int HotelPrice_Shortlist = hotelCom_Price_To_Int(driver, getObjectHotels("HotelCom_ShortlistPage_HotelPrice"));
		if(HotelPrice_Shortlist!=HotelPrice_SRP) {
			Reporter.log("Hotel price is different in Shortlist page - Price in SRP :  "+HotelPrice_SRP+"& Price in Shortlistpage : "+HotelPrice_Shortlist);
			Assert.assertTrue(false);
		}*/
