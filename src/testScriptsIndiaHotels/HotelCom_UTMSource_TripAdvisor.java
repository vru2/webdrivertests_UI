...
public class HotelCom_UTMSource_TripAdvisor extends IndiaHotels {
	public RemoteWebDriver driver;
	private String baseUrl;
	
  @Test
  public void HotelCom_TripAdvisor() throws Exception{
	  driver.manage().deleteAllCookies();
	   //https://www.cleartrip.com/hotels/details/732040?&utm_source=tripadvisor&utm_campaign=732040&c=250418|260418&r=2,0
	  hotelCom_DetailsPage(driver, "com", dataFile.value("HotelID_UTM_TA"), 40, "TA"); 
