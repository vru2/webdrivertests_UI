...
public class JSONAPIBooking_AmadeusRT_without_contact_in_Itinerary extends CommonUtils {
	...
	public void jSONApi_Book_RT_AMADEUS_5507(String from,String to,String carrier,String aCount,String cCount) throws Exception{
	...
	Test:do{
		JSONObject itinenaryId=getRoundTripItineraryIDWithOutItineraryID(clientSearch,hp,hp1,fareKey,from,to,carrier,aCount,cCount,onwarddate,returndate,i,"");
	
//System.out.println("itinerary id="+itinenaryId);
	//System.out.println(itinenaryId.getString("itinerary_id"));
		if ((common.value("makePayment").equals("true"))) { 
	JSONObject jsonObject1=jsonBookingWithContactDetails(itinenaryId,clientSearch,"");
