...
public class JSONApi_Book_Intl_OW_GST_IN_PriceCheck extends APIServices{
...
System.out.println(postString);
			...
			callPriceJson(itineraryId, headers);
...
String tripId=bookResponseJson.getString("trip_id");
