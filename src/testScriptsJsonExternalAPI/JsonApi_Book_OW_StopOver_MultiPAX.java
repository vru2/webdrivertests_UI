...
public class JsonApi_Book_OW_StopOver_MultiPAX extends CommonUtils{
	...
	public void JsonApi_Book_OW_StopOver_MultiPAX_5506(String from,String to,String carrier,String aCount,String cCount) throws Exception{
		...
		List l=getStopOverFlightDetails(hp,hp1,clientSearch,fareKeys,from,to,carrier,aCount,cCount,onwarddate,returndate,"");
	...
	Test:do{
		JSONObject itinenaryId=getStopOverItineraryID(clientSearch,hp,hp1,fareKeys,from,to,carrier,aCount,cCount,onwarddate,returndate,i,"Multi","");
