...
public class JsonB2CApi_Book_OW_Via extends CommonUtils{
	...
	public void jsonB2CApi_Book_OW_Via_11618(String from,String to,String carrier,String aCount,String cCount) throws Exception{
		...
		List l=getViaFlightDetails(hp,hp1,clientSearch,fareKeys,from,to,carrier,aCount,cCount,onwarddate,returndate,"B2C");
	...
	Test:do{
		JSONObject itinenaryId=getViaItineraryID(clientSearch,hp,hp1,fareKeys,from,to,carrier,aCount,cCount,onwarddate,returndate,i,"single","B2C");
