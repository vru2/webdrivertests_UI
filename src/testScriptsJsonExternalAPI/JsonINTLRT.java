...
public class JsonINTLRT extends CommonUtils {
	...
	public void JsonINTLRT_341(String[] from,String[] to,String[] carrier,String aCount,String cCount) throws Exception{
		...
		do {
			...
			try {
		List l=getINTLRoundtripFlightDetailsNew(hp,hp1,clientSearch,fareKey,from[k],to[k],carrier[k],aCount,cCount,onwarddate,returndate,"");
		//System.out.println(l.get(0));
		//hp=(HashMap<String, String>) l.get(0);
		hp1=(HashMap<String, String>) l.get(0);
		fareKey=(HashMap<String, String>) l.get(1);
	int i=1;
	
	Test:do{
		JSONObject itinenaryId=getRoundTripItineraryIDINTL(clientSearch,hp,hp1,fareKey,from[k],to[k],carrier[k],aCount,cCount,onwarddate,returndate,i,"");
...
Assert.assertTrue(bookingSuccess,"Booking Failed");
   //
	...
	public static Object[][] oneAdultDp(){
		String[] origin = {"DXB","BLR","DEL","DEL"};
		String[] destination = {"BOM","SIN","DXB","DXB"};
		String[] carrier = {"9W","9W","9W","AI"};
