...
public class JsonLCCOnewaySinglePAXInfoinPriceCheck extends CommonUtils{
	...
	public void jsonOnewaySinglePAX_336(String from,String to,String carrier,String aCount,String cCount) throws Exception{
		...
		Test:do{
			...
			JSONObject itinenaryId=createItinerary1(amount,key1,from,to,flightno,carrier,onwarddate,"");
			jsonPriceCheck(itinenaryId,clientSearch,"");
