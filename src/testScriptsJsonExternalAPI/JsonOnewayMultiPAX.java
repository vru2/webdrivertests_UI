...
public class JsonOnewayMultiPAX extends CommonUtils{
	...
	public void retailOneAdult_343(String from,String to,String carrier,String aCount,String cCount) throws Exception{
		...
		Test:do{
			...
			JSONObject itinenaryId=createItineraryForMultiPAX(amount,key1,from,to,flightno,carrier,onwarddate,"");
