...
public class JsonRoundTripMultiPAX_With_GST extends CommonUtils{
	...
	public void jsonRoundTripMultiPAX_342(String from,String to,String carrier,String aCount,String cCount) throws Exception{
	...
	Test:do{
		JSONObject itinenaryId=getRoundTripMultiPAXItineraryID(clientSearch,hp,hp1,fareKey,from,to,carrier,aCount,cCount,onwarddate,returndate,i,"");
	
//System.out.println("itinerary id="+itinenaryId);
	//System.out.println(itinenaryId.getString("itinerary_id"));
	JSONObject jsonObject1=jsonBooking_GST(itinenaryId,clientSearch,"",true);
	try{
