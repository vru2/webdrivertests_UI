...
public class MEAir_Beta_SA_RT_MultPax_Booking_Arabic extends AirCommonMethod 
{
	...
	public void test_MEAir_Beta_SA_RT_MultPax_Booking_Arabic(String[] fromSet, String[] toSet, String app, String tripType, String flightPreference,
			...
			boolean insuranceRequired,boolean sector, String flight_type) throws Exception 
	{
		...
		do 
		{
			...
			//*[@original-title='Show multi-airline itineraries']/../*[1]
