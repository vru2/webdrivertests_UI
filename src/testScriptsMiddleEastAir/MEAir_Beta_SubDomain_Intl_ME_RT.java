...
import domainServices.AirCommonMethod;
	...
	public class MEAir_Beta_SubDomain_Intl_ME_RT extends AirCommonMethod 
	{
				...
				boolean insuranceRequired,boolean sector, String flight_type) throws Exception 
		{
			...
			do 
			{
				...
				assertEquals("Currency  USD US", driver.findElement(By.linkText("Currency  USD US")).getText());
				Reporter.log("Currency  USD - Verifed", true);
				   
				assertTrue(isElementPresent(driver, By.linkText("United States")));
				Reporter.log("US Flag Icon - Verifed", true);
				...
				assertEquals("$", driver.findElement(By.cssSelector("th.price > span.USD")).getText());
				Reporter.log("USD $ Currency on SRP - Verifed", true);
				
				assertTrue("ME Customer Care Number Not Displayed",driver.getPageSource().contains("+973 1 6196845")); //
				Reporter.log("ME CC Number - Verifed", true);
