...
public class MEAir_Beta_SubDomain_KW_OW  extends AirCommonMethod 
{
	...
	public static Object[][] B2CAirOWLCC() {
		String origin[] = {"KWI", "KWI","KWI" };
		String destination[] = { "SHJ","DXB","DEL" };
		return new Object[][] { { origin, destination, "Flights", "OneWay", "lcc", "", "1", "0", "0", "credit card", false} };
	}

	
	@Test(dataProvider = "B2CAirOW")
	public void tets_MEAir_Beta_SubDomain_KW_OW(String[] fromSet,
			...
			throws Exception 
	{
		...
		do 
		{
			...
			Reporter.log("Currency  KWD - Verifed", true);
			
			assertTrue(isElementPresent(driver, By.cssSelector("i.flagIcon.kw")));
		    Reporter.log("KW Domain Flag Icon - Verifed", true);
		    ...
		    Reporter.log("KWD Currency on SRP - Verifed", true);
			
		    assertTrue("KWD Specific Customer Care Number Not Displayed",driver.getPageSource().contains("+973 1 6196845")); //
			Reporter.log("KW Specific CC Number - Verifed", true);
