...
public class MEAir_Beta_SubDomain_QA_OW extends AirCommonMethod
{
	...
	public static Object[][] B2CAirOWLCC() {
		String origin[] = {"doh", "DEL","DEL" };
		String destination[] = { "del","KTM","BOM" };
		return new Object[][] { { origin, destination, "Flights", "OneWay", "lcc", "", "1", "0", "0", "credit card", false} };
	}

	
	@Test(dataProvider = "B2CAirOW")
	public void test_MEAir_Beta_SubDomain_QA_OW(String[] fromSet,
			...
			throws Exception 
	{
		...
		do 
		{
			...
			Reporter.log("Currency  QAR - Verifed", true);
			
			assertTrue(isElementPresent(driver, By.cssSelector("i.flagIcon.qa")));
		    Reporter.log("QA Domain Flag Icon - Verifed", true);
		    ...
		    Reporter.log("QAR Currency on SRP - Verifed", true);
					   
			assertTrue("QA Specific Customer Care Number Not Displayed",driver.getPageSource().contains("+973 1 6196845")); //
			Reporter.log("QA Specific CC Number - Verifed", true);
