...
public class MEAir_Beta_UnsignedUser_INTL_Oneway_ extends AirCommonMethod {
	...
	public void test_MEAir_Dom_OW_LCC_Booking_Arabic_36484(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
		...
		do {
			...
			//unsigned user flow
//			Thread.sleep(1000);
//			driver.findElement(By.xpath("//input[@id='username']")).sendKeys("yashmin.b@cleartrip.com");
