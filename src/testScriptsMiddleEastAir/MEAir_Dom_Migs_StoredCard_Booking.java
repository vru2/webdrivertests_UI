...
public class MEAir_Dom_Migs_StoredCard_Booking extends AirCommonMethod { 
	...
	public static Object[][] B2CAirOWLCCDomFullRefund() {
		...
		return new Object[][] { { origin, destination, "Flights", "OneWay", "", "", "", "1", "1", "0",
				"storedcardmigs", false} };
	}
	
	@Test(dataProvider = "B2CAirOWLCC")
	public void MEAir_Dom_MigsStoredCard_Booking_466(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
