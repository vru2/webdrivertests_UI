...
public class MEAir_Dom_SubDomain_QA_OW_ConvinienceCheck extends AirCommonMethod{
	...
	public static Object[][] B2CAirOWLCC() {
		...
		String destination[] = { "BOM", "MAA", "GOI" };
		return new Object[][] { { origin, destination, "Flights", "OneWay", "", "", "1", "0", "0", "credit card", false} };
	}

	@Test(dataProvider = "B2CAirOW")
	public void MEair_Intl_OW_Booking_456(String[] fromSet, String[] toSet, String app, String tripType, String flight_type,
