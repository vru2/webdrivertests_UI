...
public class MEAir_Intl_RT_GDS_MultPax_Booking_Arabic extends AirCommonMethod {
	...
	public static Object[][] B2CAirRNDGDSIntl() {
		String origin[] = { "DXB", "JED", "AUH" };
		String destination[] = { "DEL", "DEL", "MCT" };
	...
	public void MEAir_Intl_RT_GDS_MultPax_Booking_Arabic_36485(String[] fromSet, String[] toSet, String app, String tripType, String flightPreference,
