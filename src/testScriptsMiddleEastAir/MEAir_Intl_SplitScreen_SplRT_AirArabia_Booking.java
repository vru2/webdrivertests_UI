...
public class MEAir_Intl_SplitScreen_SplRT_AirArabia_Booking extends AirCommonMethod {
	...
	public static Object[][] MeAirIntlSplRT() {
		String[] Origin = { "DXB", "AUH", "SHJ" };
		String[] Destination = { "DOH", "JED", "DOH" };
		return new Object[][] { { Origin, Destination, "Flights", "OneWay", "",
				"Direct", "1", "0", "0", "credit card", false } };
	}

	@Test(dataProvider = "AirIntlSplRT")
	public void test_MEAir_Intl_SplitScreen_SplRT_AirArabia_Booking_36477(String[] fromSet, String[] toSet, String app, String tripType, String flightPreference,
		...
		do {
			...
			flightFound = meSelectSplRoundTripFlightIntl(driver, "lcc", "air arabia");
