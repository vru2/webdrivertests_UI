...
public class MEAir_RT_Coupon_Booking extends AirCommonMethod {
	...
	public static Object[][] B2CAirRT() {
		...
		return new Object[][] { { origin, destination, "Flights", "RoundTrip", "Vistara", "Non Direct", "1", "0", "0",
				"credit card", "Via", false,false, "" } };
	}
	

	
	@Test(dataProvider= "B2CAirRT")
	public void Air_Dom_RT_coupon_Booking_442(String[] fromSet, String[] toSet, String app, String tripType,
