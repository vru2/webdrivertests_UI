...
public class MEAir_SubDomain_OM_Generic_UI_Check extends AirCommonMethod  {
	...
	public void MEAir_OMSite_Generic_Check_463(String[] fromSet,
		...
		Reporter.log("Currency  OMR - Verifed");
		//System.out.println("Currency  OMR - Verifed");
	   
		assertTrue(isElementPresent(driver, By.cssSelector("i.flagIcon.om")));
	    Reporter.log("OM Domain Flag Icon - Verifed");
		//System.out.println("OM Domain Flag Icon - Verifed");
	    ...
	    Reporter.log("OMR Currency on SRP - Verifed");
		//System.out.println("OMR Currency on SRP - Verifed");
	   
		assertTrue("OM Specific Customer Care Number Not Displayed",driver.getPageSource().contains("800-74521")); //
		    
	    Reporter.log("OM Specific CC Number - Verifed");
		//System.out.println("OM Specific CC Number - Verifed");
	...
	public void startSelenium() throws Exception {
		...
		baseUrl = dataFile.value("url_om_qa2");
