...
public class ME_Air_AE_Dom_LCC_Airlines_Check extends AirCommonMethod{
	...
	public void me_Air_AE_Dom_LCC_Airlines_Check(String[] origin, String[] destin, String app, String tripType, String airlines,String adults, String children, String infants,String flightPreference) throws Exception {
		...
		driver.get("https://www"+common.value("url")+domain+"/flights/results?from="+origin[attempt]+"&to="+destin[attempt]+"&depart_date="+onwarddate +"&adults=1&childs=0&infants=0&class=Economy&airline="+airlines+"&carrier=");
	...
	public static Object[][] B2CAirOWLCCDomFullRefund() {
		...
		String destination6E [] = {"BOM", "CMB", "BLR"};
		
		String originSG [] = {"DEL", "MAA", "CMB"};
		String destinationSG [] = {"BOM", "CMB", "BLR"};
