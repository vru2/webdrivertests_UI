	...
	public class ME_Air_Intl_AirArabia_Marco_Booking extends AirCommonMethod 
	{
		...
		{
			String origin[] = { "AMS", "CMN"};
			String destination[] = {"TNG", "BRU"};
			//String airline[] = {"Air Arabia M Shuttle","Jazeera Airways","Norwegian Shuttle"};
			return new Object[][] 
					{ 
				...
				boolean insuranceRequired) throws Exception 
		{
			...
			int attempt = 0;
			ArrayList<String> filterByAirlines = new ArrayList<String>(Arrays.asList("Air Arabia", "Air Arabia"));
