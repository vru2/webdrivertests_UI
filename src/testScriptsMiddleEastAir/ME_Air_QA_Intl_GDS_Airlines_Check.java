...
public class ME_Air_QA_Intl_GDS_Airlines_Check extends AirCommonMethod{
	...
	public void me_Air_QA_Intl_GDS_Airlines_Check(String[] origin, String[] destin, String app, String tripType, String airlines,String adults, String children, String infants,String flightPreference) throws Exception {
		...
		driver.get("https://qa"+common.value("url")+domain+"/flights/international/results?from="+origin[attempt]+"&to="+destin[attempt]+"&depart_date="+onwarddate +"&adults=1&childs=0&infants=0&class=Economy&airline=&carrier=&intl=y&sd=1534489553782&nearbyairportsDest=SHJ-AUH-ZVJ-XNB-DXB&nearbyairportsOrigin=&fareoptions=WITHBAG-WITHOUTBAG&airlines="+airlines+"&tripDuration=3-36&layoverDuration=0-23");
