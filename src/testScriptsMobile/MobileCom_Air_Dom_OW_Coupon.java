...
import domainServices.Mobile;
	...
	public class MobileCom_Air_Dom_OW_Coupon extends Mobile
	{
		...
		@Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileCom_Dom_OW_3")
		public void mobileCom_Air_Dom_OW_Coupon_415(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Trip_Logger_Msg, String Carrier1, String Carrier2, String Carrier3) throws Exception 
		{
			...
			driver.get(baseUrl);
		  	...
		  	mobileCom_Air_MakePaymentPage(driver, "COUPON", "", Trip_Logger_Msg);  
