...
import domainServices.Mobile;
	public class PWA_MobileWeb_MEAir_Dom_KW extends Mobile {
		...
		String pgfees;
		  ...
		  public void pwa_MEAir_KW_DOM_OW(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Trip_Logger_Msg, String Carrier1, String Carrier2, String Carrier3) throws Exception {
			 System.out.println(baseUrl);
			 driver.get(common.value("pwaairurlKW"));

			 
			 Reporter.log("PWA_MobileWeb_MEAir_Dom_KW",true);
			 //pwa_signIn(driver);
