...
public class PWA_MobileWeb_Air_Dom_RT_SignedIn_PGCheck_CC_9 extends Mobile{
...
String pgfees;
  ...
  public void pwa_MobileWeb_Air_Dom_RT_with_PGCheck_40211(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Trip_Logger_Msg, String Carrier1, String Carrier2, String Carrier3) throws Exception {
	 ...
	 Reporter.log("PWA_MobileWeb_Air_Dom_RT",true);
	 ...
	 int pgfees=Integer.parseInt(pgdetails.replace(",",""));
