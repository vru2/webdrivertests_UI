...
public class PWA_MobileWeb_Air_INTL_OW_APNS_Check extends Mobile{
...
String pgfees;
  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileCom_Intl_RT", groups={ "Smoke Test"})
  public void pwa_MobileWeb_Air_INTL_OW_APNS_Check(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Trip_Logger_Msg) throws Exception {
	 System.out.println(common.value("pwaairurl"));
