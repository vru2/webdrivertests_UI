...
public class PWA_MobileWeb_Air_Unsigned_Dom_OW_with_GST_5 extends Mobile{
	//EBL-6783
...
String pgfees;
  ...
  public void pwa_MobileWeb_Air_Dom_OW_with_GST_40210(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Trip_Logger_Msg, String Carrier1, String Carrier2, String Carrier3) throws Exception {
	 ...
	 pwa_Air_Bookstep2(driver,Adults,Childrens,Infants,"gst");
