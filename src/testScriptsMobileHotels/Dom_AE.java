...
import domainServices.MobileHotels;
	...
	public class Dom_AE extends MobileHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

	@Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileCom_Hotel_MultiPax_MultiRoom")
  	public void MobileAE_Hotel_MultiPaxRoom(String City, String From_Date, String To_Date, String Rooms, String AdultsInRoom1, String AdultsInRoom2, String ChildInRoom1, String ChildInRoom2, String ChildAgeInRoom1, String ChildAgeInRoom2, String Hotel_Name, String Trip_Logger_Msg) throws Exception {
		  driver.manage().deleteAllCookies();
		  driver.get(baseUrl);
		  if(elementVisible(driver, By.id("english_select"), 2)) {
			  safeClick(driver, By.id("english_select"));
		  }
		  ...
		  mobileCom_Hotel_PaymentPage(driver, "", "Mobile Web AE : ");
		  mobileCom_Hotel_ConfirmationPage(driver, "", "AE Multipax ", "Your booking is done");
	}
