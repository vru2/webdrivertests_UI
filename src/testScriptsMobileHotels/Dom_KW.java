...
import domainServices.MobileHotels;
	...
	public class Dom_KW extends MobileHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileQA_Hotel_MultiPax_MultiRoom")
  public void MobileCom_Hotel_KW(String City, String From_Date, String To_Date, String Rooms, String AdultsInRoom1, String AdultsInRoom2, String ChildInRoom1, String ChildInRoom2, String ChildAgeInRoom1, String ChildAgeInRoom2, String Hotel_Name, String Trip_Logger_Msg) throws Exception {
	  ...
	  mobileCom_Hotel_PaymentPage(driver, "", "Mobile Web KW : ");
	  mobileCom_Hotel_ConfirmationPage(driver, "", "Mobile Web KW : ", "Your booking is done");	  
  }

  @BeforeClass
  public void setUp() throws Exception {
	driver=getMobileDriver1(driver);
	baseUrl = common.value("urlkw");
  }
