...
import domainServices.MobileHotels;
	...
	public class Dom_OM extends MobileHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileQA_Hotel_MultiPax_MultiRoom")
  public void MobileOM_Hotel_MultiPaxRoom(String City, String From_Date, String To_Date, String Rooms, String AdultsInRoom1, String AdultsInRoom2, String ChildInRoom1, String ChildInRoom2, String ChildAgeInRoom1, String ChildAgeInRoom2, String Hotel_Name, String Trip_Logger_Msg) throws Exception {
	 ...
	 /* mobileCom_Hotel_PaymentPage(driver, "", "Mobile Web OM : ");
	  mobileCom_Hotel_ConfirmationPage(driver, "", "Mobile Web OM : ", "Your booking is done");*/
  }

  @BeforeClass
  public void setUp() throws Exception {
		driver=getMobileDriver3(driver);
		baseUrl = getBaseUrl( "om");
  }
