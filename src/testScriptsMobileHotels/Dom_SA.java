...
import domainServices.MobileHotels;
	...
	public class Dom_SA extends MobileHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileQA_Hotel_MultiPax_MultiRoom")
  public void Mobile_Hotel_SA(String City, String From_Date, String To_Date, String Rooms, String AdultsInRoom1, String AdultsInRoom2, String ChildInRoom1, String ChildInRoom2, String ChildAgeInRoom1, String ChildAgeInRoom2, String Hotel_Name, String Trip_Logger_Msg) throws Exception {
	  driver.manage().deleteAllCookies();
	  driver.get(baseUrl);
	  if(elementVisible(driver, By.id("english_select"), 5)) {
	  ...
	  mobileCom_Hotel_PaymentPage(driver, "", "Mobile Web SA : ");
	  mobileCom_Hotel_ConfirmationPage(driver, "", "Mobile Web SA : ", "Your booking is done");
