...
import domainServices.MobileHotels;
	...
	public class GST_Edit extends MobileHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileCom_Hotel_SinglePax")
  public void MobileCom_Hotel_GSTEDIT(String City, String From_Date, String To_Date, String Adults, String Childrens, String Hotel_Name, String Trip_Logger_Msg) throws Exception {
	  ...
	  mobileCom_Hotel_TravellerPage_GST(driver, "GSTEDIT");
	  mobileCom_Hotel_PaymentPage(driver, "" , "");
	  mobileCom_Hotel_ConfirmationPage(driver, "", "Mobile Web GST Edit", "Your Booking is Done");
	 }
