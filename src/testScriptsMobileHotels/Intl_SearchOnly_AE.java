...
import domainServices.MobileHotels;
	...
	public class Intl_SearchOnly_AE extends MobileHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test 
  public void mobileAE_Hotel_Intl_SearchOnly() throws Exception {
	  driver.get(baseUrl);
	  mobileCom_Hotel_HomepageSearch(driver, "Dubai",  "20", "21", "2", "0");
