...
import domainServices.MobileHotels;
	...
	public class Meta_TripAdvisor extends MobileHotels{
	public RemoteWebDriver driver;
	String baseUrl;
	
  @Test
  public void mobileCom_MobileWeb_GoogleHPA() throws Exception {
	  String HotelName = dataFile.value("HotelName_Mobileweb_UTM_TA");
	  String CheckIn_Date = putDate1(20);
	  String CheckOut_Date = putDate1(21);
	  String CityName = "Bangalore";
	  String StateName = "Karnataka";
	  driver.manage().deleteAllCookies();  
	  driver.get(baseUrl+"/m/hotels/results?city="+CityName+"&country=IN&state="+StateName+"&ckIn="+CheckIn_Date+"&ckOut="+CheckOut_Date+"&noOfRooms=1&ad=2&cd=0&pahCCRequired=true&utm_source=tripadvisor&#filter?filterType=hotelName&filterValue="+HotelName);
	  ...
	  mobileCom_Hotel_PaymentPage(driver, "", "Mobile Web Meta TA : ");
	  mobileCom_Hotel_ConfirmationPage(driver, "", "Mobile Web Meta TA", "Your booking is done");
  }
