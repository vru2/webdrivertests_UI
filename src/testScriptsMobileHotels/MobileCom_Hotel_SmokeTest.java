...
import domainServices.MobileHotels;
	...
	public class MobileCom_Hotel_SmokeTest extends MobileHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileCom_Hotel_SinglePax")
  public void mobileCom_Hotel_SignIN_Step2_423(String City, String From_Date, String To_Date, String Adults, String Childrens, String Hotel_Name, String Trip_Logger_Msg) throws Exception {
	  ...
	  mobileCom_Hotel_PaymentPage(driver, ""," Hotel Step2 SignIN");	  
	  mobileCom_Hotel_ConfirmationPage(driver, "", "Mobile Web Hotels", "Your booking is done");
  }
