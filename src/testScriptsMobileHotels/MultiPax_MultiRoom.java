...
import domainServices.MobileHotels;
	...
	public class MultiPax_MultiRoom extends MobileHotels{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileCom_Hotel_MultiPax_MultiRoom")
  public void mobileCom_Hotel_MultiPaxRoom_422(String City, String From_Date, String To_Date, String Rooms, String AdultsInRoom1, String AdultsInRoom2, String ChildInRoom1, String ChildInRoom2, String ChildAgeInRoom1, String ChildAgeInRoom2, String Hotel_Name, String Trip_Logger_Msg) throws Exception {
	  driver.get(baseUrl);
	  ...
	  mobileCom_Hotel_PaymentPage(driver, "CC", " MultiPax Multi room" );
	  mobileCom_Hotel_ConfirmationPage(driver, "", "B2C MultiPax", "Your booking is done");
  }
