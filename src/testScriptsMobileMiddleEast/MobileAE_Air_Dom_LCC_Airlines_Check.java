...
public class MobileAE_Air_Dom_LCC_Airlines_Check extends Mobile{
  ...
  public void mobileAE_Air_Dom_LCC_Airlines_Check(String[] origin, String[] destin, String app, String tripType, String airlines,String adults, String children, String infants,String flightPreference) throws Exception {
	  driver.get(baseUrl);
	  ...
	  System.out.println(driver.getCurrentUrl()+"/flights/results?rnd_one=O&from="+origin[attempt]+"&to="+destin[attempt]+"&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&mobile=true&class=Economy&carrier=&dep_time=0&airline_codes="+airlines);
