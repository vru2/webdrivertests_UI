...
public class MobileBH_Air_Intl_LCC_Airlines_Check extends Mobile{
  ...
  public void mobileBH_Air_Intl_LCC_Airlines_Check(String[] origin, String[] destin, String app, String tripType, String airlines,String adults, String children, String infants,String flightPreference) throws Exception {
	  driver.get(baseUrl);
