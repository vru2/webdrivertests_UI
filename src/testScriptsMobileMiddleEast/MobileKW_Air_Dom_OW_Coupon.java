package testScriptsMobileMiddleEast;
	...
	import domainServices.Mobile;
		...
		public class MobileKW_Air_Dom_OW_Coupon extends Mobile{
		public RemoteWebDriver driver;
		private String baseUrl;

	  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileKW_Dom_OW")
	  public void MobileKW_Dom_OW_12(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Trip_Logger_Msg, String Carrier1, String Carrier2, String Carrier3) throws Exception {
		  driver.get(baseUrl);
