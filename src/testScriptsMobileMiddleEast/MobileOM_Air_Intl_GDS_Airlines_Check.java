...
public class MobileOM_Air_Intl_GDS_Airlines_Check extends Mobile{
  ...
  public void mobileOM_Air_Intl_GDS_Airlines_Check(String[] origin, String[] destin, String app, String tripType, String airlines,String adults, String children, String infants,String flightPreference) throws Exception {
	  driver.get(baseUrl);
