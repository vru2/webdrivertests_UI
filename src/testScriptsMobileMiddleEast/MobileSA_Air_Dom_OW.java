...
import domainServices.Mobile;
	...
	public class MobileSA_Air_Dom_OW extends Mobile{
	public RemoteWebDriver driver;
	private String baseUrl;

  @Test ( dataProviderClass = MobileDataProvider.class,dataProvider="MobileSA_Dom_OW")
  public void mobileSA_Air_Dom_OW_434(String FromCity, String ToCity, String From_Date, String To_Date, String Adults, String Childrens, String Infants, String Trip_Logger_Msg, String Carrier1, String Carrier2, String Carrier3) throws Exception {
	  driver.get(baseUrl);
	  ...
	  mobileCom_Air_SRP_Oneway(driver, Carrier1, Carrier3, Carrier2);
