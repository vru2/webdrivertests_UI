...
public class MobileTrains_CheckAvailability extends Trains{
	...
	public void mobileTrains_CheckAvailability(String DStation, String AStaiton, String Class, String TDate,String Quota,String BoardStation,String TrainsName,String Adult1,String Child1,String SMen,String SWomen,String Payment_Type, 
		...
		Thread.sleep(3000);
		mobileTrains_CheckAvailClasses(driver,Quota,BoardStation,TrainsName);
			}
