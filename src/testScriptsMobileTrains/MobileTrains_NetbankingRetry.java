...
public class MobileTrains_NetbankingRetry extends Trains{
	...
	@DataProvider
	  public static Object [ ][ ] MobileTrains_NetbankingRetry() {
	      return new Object [ ] [ ] { { "NDLS","MAS","Sleeper (SL)","10","General","Same","G T Express","1","0","0","0","Net Banking","B2C Trains HomePage SignIn General Booking with Adult=1","Your Booking is confirmed","Cancel"}};
	     
	 
	  };
	  
	@Test(dataProvider="MobileTrains_NetbankingRetry")
	public void mobileTrains_NetbankingRetry(String DStation, String AStaiton, String Class, String TDate,String Quota,String BoardStation,String TrainsName,String Adult1,String Child1,String SMen,String SWomen,String Payment_Type, 
