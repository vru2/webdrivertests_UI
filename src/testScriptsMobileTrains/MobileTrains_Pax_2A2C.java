...
public class MobileTrains_Pax_2A2C extends Trains{
	...
	@DataProvider
	  public static Object [ ][ ] MobileTrains_Pax_2A2C() {
	      return new Object [ ] [ ] { { "NDLS","MAS","Sleeper (SL)","10","General","Same","G T Express","2","2","0","0","CREDITCARD","B2C Trains HomePage SignIn General Booking with Adult=1","Your Booking is confirmed","Cancel"}};
	     
	  };
	  
	@Test (dataProvider="MobileTrains_Pax_2A2C")	  
	public void mobileTrains_Pax_2A2C(String DStation, String AStaiton, String Class, String TDate,String Quota,String BoardStation,String TrainsName,String Adult1,String Child1,String SMen,String SWomen,String Payment_Type, 
