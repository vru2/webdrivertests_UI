...
public class MobileTrains_RAC extends Trains{
	...
	@DataProvider
	  public static Object [ ][ ] MobileTrains_RAC() {
	      return new Object [ ] [ ] { { "SBC","Mysore","Sleeper (SL)","10","RAC","Same","G T Express","1","0","0","0","CREDITCARD","B2C Trains HomePage SignIn General Booking with Adult=1","Your Booking is confirmed","Cancel"}};
	     
	  };
	  
	@Test (dataProvider="MobileTrains_RAC")	  
	public void mobileTrains_RAC(String DStation, String AStaiton, String Class, String TDate,String Quota,String BoardStation,String TrainsName,String Adult1,String Child1,String SMen,String SWomen,String Payment_Type, 
		...
		mobileTrains_HomepageSignIn(driver);
		mobileTrains_HomepageSearch(driver,DStation,AStaiton,Class,TDate,Adult1,Child1,SMen,SWomen,"RAC",0);
