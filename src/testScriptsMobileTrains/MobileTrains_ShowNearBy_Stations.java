...
public class MobileTrains_ShowNearBy_Stations extends Trains{
	...
	public void mobileTrains_ShowNearBy_Stations(String DStation, String AStaiton, String Class, String TDate,String Quota,String BoardStation,String TrainsName,String Adult1,String Child1,String SMen,String SWomen,String Payment_Type, 
		...
		WebElement element1 = (new WebDriverWait(driver,30))
				   .until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(text(),'Show nearby stations')]")));
		nearByStation(driver);
