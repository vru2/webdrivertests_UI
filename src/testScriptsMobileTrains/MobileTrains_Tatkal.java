...
public class MobileTrains_Tatkal extends Trains{
	...
	@DataProvider
	  public static Object [ ][ ] MobileTrains_Tatkal() {
		...
		String[] destination = {"MAS","Adoni","bom","CCU"};
		
	      return new Object [ ] [ ] { { origin,destination,"Sleeper (SL)","10","Tatkal","Same","G T Express","1","0","0","0","CREDITCARD","B2C Trains HomePage SignIn General Booking with Adult=1","Your Booking is confirmed","Cancel"}};
	     
	  };
	  
	@Test (dataProvider="MobileTrains_Tatkal")	  
	public void mobileTrains_Tatkal(String[] origin, String[] destination, String Class, String TDate,String Quota,String BoardStation,String TrainsName,String Adult1,String Child1,String SMen,String SWomen,String Payment_Type, 
