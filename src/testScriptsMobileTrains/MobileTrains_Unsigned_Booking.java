...
public class MobileTrains_Unsigned_Booking extends Trains{
	...
	@DataProvider
	  public static Object [ ][ ] MobileTrains_with_GST() {
	      return new Object [ ] [ ] { { "SBC","MAS","Sleeper (SL)","10","General","Same","G T Express","1","0","0","0","CREDITCARD","B2C Trains HomePage SignIn General Booking with Adult=1","Your Booking is confirmed","Cancel"}};
