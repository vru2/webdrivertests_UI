...
public class B2CPackageDomFlexiDates extends AirCommonMethod {
	...
	public void packageDomFlexiDates_439(String[] fromSet, String[] toSet, String app, String tripType, String flightFilterType, String rooms,
...
//driver.findElement(By.id("Packages")).click();
			...
			airComHomepageSearchPackageFlexiDates(driver, fromSet[attempt], toSet[attempt], "10", "12", rooms, adults, children, attempt);
			...
			// safeClick(driver, getObject("PackageSRPPrefferedAirline"));
			/*
			 * try { safeSelect(driver, getObject("PackageSRPPrefferedAirline"), "Air India"); } catch (Exception e) { try {
			 * safeSelect(driver, getObject("PackageSRPPrefferedAirline"), "SpiceJet"); } catch (Exception ex) {
			...
			// assert if new hotel flexi dates are reflecting
			assertTrue("Hotel flexi dates not as per selection made! Error!",
					"10".equals(driver.findElement(By.xpath("//li[1]/time/span[1]/strong")).getText().trim()));
			assertTrue("Hotel flexi dates not as per selection made! Error!",
					"11".equals(driver.findElement(By.xpath("//li[3]/time/span[1]/strong")).getText().trim()));
