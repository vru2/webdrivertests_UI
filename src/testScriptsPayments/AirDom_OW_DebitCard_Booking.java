...
public class AirDom_OW_DebitCard_Booking extends AirCommonMethod {
	...
	public void airDom_OW_DebitCard_Booking_160(String[] fromSet, String[] toSet, String app, String tripType,
		...
		do {
			...
			if (reachedPaymentStep) {
				if ((common.value("makePayment").equals("true"))) {
					paymentDone = b2cPayment(driver, paymentMethod, 4);
					boolean error = false;
					if (paymentDone == true)
