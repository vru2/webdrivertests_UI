...
public class AirDom_OW_Full_CTWallet_Booking extends AirCommonMethod {
	...
	public void airDom_OW_Full_CTWallet_Booking_155(String[] fromSet, String[] toSet, String app, String tripType,
		...
		if (paymentDone) {
			...
			if (bookingPassed && paymentMethod.equals("ctwallet")) {
