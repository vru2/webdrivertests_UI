...
import domainServices.AgencyHotels;
	...
	public class DA_Hotel_Agency extends AgencyHotels{
	public RemoteWebDriver driver;

	@DataProvider(name = "PaxPayment")
    public Object [ ][ ] Hotel_domestic() throws Exception {
      return new Object [ ] [ ] { { "Bangalore", "19", "20", "1", "0", "2", "3", "2", "1", "1", "1", "0", "", "DEPOSITACCOUNT", "Agency Hotels 3 adults 1 child DA TripID : ", "We have confirmed your booking & emailed you all the details."}	    		  					 
      	};
  }
	
	 @Test(dataProvider = "PaxPayment", groups="Regression")
  public void agencyHotel_DA(String City, String CheckIn_Date, String CheckOut_Date, String Rooms, String Adult1, String Adult2, 
		...
		agencyHotel_Paymentpage(driver, Payment_Type, "", "Agency Payment DA ", Booking_Confirmation_Message);
	}
