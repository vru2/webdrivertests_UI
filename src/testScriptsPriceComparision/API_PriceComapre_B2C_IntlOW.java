...
import testScriptsExternalAPICommon.CommonUtils;
	...
	public class API_PriceComapre_B2C_IntlOW extends CommonUtils{
		...
		public static Object[][] priceComparision_DOMOW() {
			String[] origin0 = {"DEL"};
			String[] destination0 = {"DXB"};
			String[] origin1 = {"BOM"};
			String[] destination1 = {"SIN"};
			
			return new Object[][] { { origin0, destination0},{ origin1, destination1} };
		}
		
		
		@Test(dataProvider = "priceComparision_DOMOW")
		public void IntlOW_Connector_Search(String[] origin,String[] destination) throws Exception{
			String src=origin[0];
