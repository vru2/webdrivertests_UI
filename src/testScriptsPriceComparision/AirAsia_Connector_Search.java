...
import domainServices.AirCommonMethod;
	...
	public class AirAsia_Connector_Search  extends CommonUtils {
			
			String AirLine = "AIR_ASIA";
			String connectortype = "I5";
			public RemoteWebDriver driver = null;
			
		@Test
		public void AirAsia_R1_Connector_Results() throws Exception{
			...
			try
				...
				String searchUrl="http://air-api.cltp.com:9001/"+common.value("envtprod")+"/airservice/search?from=BLR&to=GOI&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&class=Economy&airline="+connectortype+"&carrier="+connectortype+"&intl=n&sd=1454917568526&src=connector&debug=1&responseType=jsonV3";
		...
		@Test
		public void AirAsia_R3_Connector_Results() throws Exception{
			...
			try
				...
				String searchUrl="http://air-api.cltp.com:9001/"+common.value("envtbeta")+"/airservice/search?from=BLR&to=GOI&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&class=Economy&airline="+connectortype+"&carrier="+connectortype+"&intl=n&sd=1454917568526&src=connector&debug=1&responseType=jsonV3";
				Reporter.log("envtbeta is on -"+ common.value("envtbeta") + connectortype + " searchUrl :" + searchUrl);
