...
public class B2CPriceComparisionDomRND extends AirCommonMethod {
...
String destination="";
		...
		void captureAllValues() throws Exception {
			...
			/*List<WebElement> we2=driver.findElements(By.xpath("//tbody/tr/td/span"));
			for(int i=0;i<we2.size();i++){
				//System.out.println("text="+we2.get(i).getText());
			}*/
			...
			////System.out.println("price======="+driver.findElement(By.xpath("//div/h2[@class='totalAmount']")).getText());
