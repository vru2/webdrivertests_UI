...
import testScriptsExternalAPICommon.CommonUtils;
	...
	public class Connector_9W_Search  extends CommonUtils{
			
			String AirLine = "AMADEUS";
			String connectortype = "9W";
			
			
		@Test
		public void Connector_9W_R1_Results() throws Exception{
		...
		@Test
		public void Connector_9W_R3_Results() throws Exception{
