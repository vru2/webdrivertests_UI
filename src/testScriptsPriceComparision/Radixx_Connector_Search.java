...
import testScriptsExternalAPICommon.CommonUtils;
	...
	public class Radixx_Connector_Search  extends CommonUtils{
			
			String AirLine = "RADIXX";
			String connectortype = "G8";
			
			
		@Test
		public void Radixx_R1_Connector_Results() throws Exception{
			...
			try
				...
				String searchUrl="http://air-api.cltp.com:9001/"+common.value("envtprod")+"/airservice/search?from=BLR&to=DEL&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&class=Economy&airline=G8&carrier=G8&intl=n&sd=1454917568526&src=connector&debug=1&responseType=jsonV3";
		...
		@Test
		public void Radixx_R3_Connector_Results() throws Exception{
			...
			try
		    	...
		    	DefaultHttpClient Client = new DefaultHttpClient();
		    	String onwarddate=putDate(common.value("Api_add_search_date"));
				String searchUrl="http://air-api.cltp.com:9001/"+common.value("envtbeta")+"/airservice/search?from=BLR&to=DEL&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&class=Economy&airline=G8&carrier=G8&intl=n&sd=1454917568526&src=connector&debug=1&responseType=jsonV3";
