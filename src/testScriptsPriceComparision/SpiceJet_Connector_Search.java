...
public class SpiceJet_Connector_Search  extends CommonUtils{
		
		String AirLine = "SPICEJET";
		String connectortype = "SG";
		
		
	@Test
	public void SpiceJet_R1_Connector_Results() throws Exception{
		...
		try
			...
			String searchUrl="http://172.17.12.25:9080/"+common.value("envtprod")+"/airservice/search?from=BLR&to=MAA&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&class=Economy&airline="+connectortype+"&carrier="+connectortype+"&intl=n&sd=1454917568526&src=connector&debug=1&responseType=jsonV3";
	...
	@Test
	public void SpiceJet_R3_Connector_Results() throws Exception{
		...
		try
			...
			String searchUrl="http://air-api.cltp.com:9001/"+common.value("envtbeta")+"/airservice/search?from=BLR&to=MAA&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&class=Economy&airline="+connectortype+"&carrier="+connectortype+"&intl=n&sd=1454917568526&src=connector&debug=1&responseType=jsonV3";
