...
public class Vistara_Connector_Search  extends CommonUtils{
		
		String AirLine = "AMADEUS";
		String connectortype = "UK";
		
		
	@Test
	public void Vistara_Connector_R1_Results() throws Exception{
		...
		try
			...
			String searchUrl="http://air-api.cltp.com:9001/"+common.value("envtprod")+"/airservice/search?from=BLR&to=DEL&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&class=Economy&airline="+connectortype+"&carrier="+connectortype+"&intl=n&sd=1454917568526&src=connector&debug=1&responseType=jsonV3";
			...
			Assert.assertTrue(fk.contains(AirLine), "SEARCHED AIRLINE NOT PRESENT");
	...
	@Test
	public void Vistara_Connector_R3_Results() throws Exception{
		...
		try
	    	...
	    	String searchUrl="http://air-api.cltp.com:9001/"+common.value("envtbeta")+"/airservice/search?from=BLR&to=DEL&depart_date="+onwarddate+"&adults=1&childs=0&infants=0&class=Economy&airline="+connectortype+"&carrier="+connectortype+"&intl=n&sd=1454917568526&src=connector&debug=1&responseType=jsonV3";
