...
public class RewardSanityAmountCheck extends HQ {
	...
	@Test()
	public void rewardSanityAmountCheck() throws Exception {
		...
		JsonObject jsonObject = createJsonReward(Username_HQ_Reward_qa2, userID_HQ_Reward_qa2, "air", "hotel", 1, 2, 5000, 2000, travellerA,
				"", "");
		...
		assertTrue(trips.get(1).equals(tripsDetailsFromDashboard.get(1).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(2).equals(tripsDetailsFromDashboard.get(2).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		...
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(1).findElement(getObject("Reward_Program_Trips_CouponStatus"))
				.getText()));
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(2).findElement(getObject("Reward_Program_Trips_CouponStatus"))
				.getText()));

		se = new StringEntity(
				createJsonReward(Username_HQ_Reward_qa2, userID_HQ_Reward_qa2, "hotel", "", 1, -1, 2000, -1, travellerA, "", "").toString());
		httppostBook.setEntity(se);
		...
		se = new StringEntity(createJsonReward(Username_HQ_Reward_qa2, userID_HQ_Reward_qa2, "air", "hotel", 1, 2, 5000, 5000, travellerA,
				"", "").toString());
		httppostBook.setEntity(se);
		response = httpclient.execute(httppostBook);
		entity = response.getEntity();
		...
		assertTrue(trips.get(0).equals(tripsDetailsFromDashboard.get(4).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(1).equals(tripsDetailsFromDashboard.get(5).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(2).equals(tripsDetailsFromDashboard.get(6).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		...
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(5).findElement(getObject("Reward_Program_Trips_CouponStatus"))
				.getText()));
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(6).findElement(getObject("Reward_Program_Trips_CouponStatus"))
				.getText()));

		se = new StringEntity(
				createJsonReward(Username_HQ_Reward_qa2, userID_HQ_Reward_qa2, "hotel", "", 1, -1, 5000, -1, travellerA, "", "").toString());
		httppostBook.setEntity(se);
		response = httpclient.execute(httppostBook);
		entity = response.getEntity();
		responseString = EntityUtils.toString(entity, "UTF-8");
		...
		se = new StringEntity(createJsonReward(Username_HQ_Reward_qa2, userID_HQ_Reward_qa2, "air", "", 6, -1, 6499, -1, travellerA, "", "")
				.toString());
		httppostBook.setEntity(se);
		response = httpclient.execute(httppostBook);
		entity = response.getEntity();
		...
		assertTrue(trips.get(0).equals(tripsDetailsFromDashboard.get(8).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(1).equals(tripsDetailsFromDashboard.get(9).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(2).equals(tripsDetailsFromDashboard.get(10).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(3).equals(tripsDetailsFromDashboard.get(11).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(4).equals(tripsDetailsFromDashboard.get(12).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(5).equals(tripsDetailsFromDashboard.get(13).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		...
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(12)
				.findElement(getObject("Reward_Program_Trips_CouponStatus")).getText()));
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(13)
				.findElement(getObject("Reward_Program_Trips_CouponStatus")).getText()));
		...
		assertTrue(trips.get(0).equals(tripsDetailsFromDashboard.get(14).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		...
		assertTrue("Sent".equals(tripsDetailsFromDashboard.get(13).findElement(getObject("Reward_Program_Trips_CouponStatus"))
				.getText()));
		assertTrue("Sent".equals(tripsDetailsFromDashboard.get(14).findElement(getObject("Reward_Program_Trips_CouponStatus"))
				.getText()));
		...
		assertTrue(trips.get(0).equals(tripsDetailsFromDashboard.get(15).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(15)
				.findElement(getObject("Reward_Program_Trips_CouponStatus")).getText()));
		assertTrue("2nd round".equals(tripsDetailsFromDashboard.get(15)
