...
public class RewardSanityMinBookingsForProductsPlusTravellerCheck extends HQ {
	...
	@Test()
	public void rewardSanityMinBookingsForProductsPlusTravellerCheck() throws Exception {
		...
		JsonObject jsonObject = createJsonReward(Username_HQ_Reward_qa2, userID_HQ_Reward_qa2, "hotel", "", 3, -1, 5000, -1,
				travellerA, "", "");
		...
		se = new StringEntity(createJsonReward(Username_HQ_Reward_qa2, userID_HQ_Reward_qa2, "hotel", "", 3, -1, 5000, -1,
				travellerB, "", "").toString());
		httppostBook.setEntity(se);
		response = httpclient.execute(httppostBook);
		entity = response.getEntity();
		...
		jsonObject = createJsonReward(Username_HQ_Reward_qa2, userID_HQ_Reward_qa2, "hotel", "", 1, -1, 5000, -1,
				travellerC, "", "");
		...
		assertTrue(trips.get(0).equals(tripsDetailsFromDashboard.get(11).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(1).equals(tripsDetailsFromDashboard.get(12).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue(trips.get(2).equals(tripsDetailsFromDashboard.get(13).findElement(getObject("Reward_Program_Trips_TripId"))
				.getText()));
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(8).findElement(getObject("Reward_Program_Trips_CouponStatus"))
				.getText()));
		assertTrue("Not sent".equals(tripsDetailsFromDashboard.get(9).findElement(getObject("Reward_Program_Trips_CouponStatus"))
