...
public class Pax_2A_FirstClass_RAC extends Trains{
	...
	@DataProvider
		public static Object [ ][ ] B2cTrainsRAC() {
			return new Object [ ] [ ] { { "SBC","MAS","First Class (FC)","10","RAC","Same","Kaveri Express","2","0","0","0","CREDIT CARD","B2C Trains HomePage SignIn General Booking with Adult=1","Your Booking is confirmed","Cancel"}};

		};
	  
	@Test (dataProvider="B2cTrainsRAC",alwaysRun = true)	  
	public void B2cTrains_Pax_2Adults_RAC(String DStation, String AStaiton, String Class, String TDate,String Quota,String BoardStation,String TrainsName,String Adult1,String Child1,String SMen,String SWomen,String Payment_Type, 
